...
var spanishEnabled = 'false';
	...
	resources['ffe.ee.shared.status'] = 'Status:';
...
$.referenceTypes = {};
	resources['ffe.ee.myProfile.profile.startApplication.hidden.stepModal'] = 'you are in step modal';
	resources['ffe.ee.myProfile.profile.startApplication.heading'] = '<%=displayedStateName%> application for individuals &amp; families';
	resources['ffe.ee.myProfile.profile.startApplication.list1.tax'] = 'Anyone on your same federal income tax return &#40;if you file one&#41;';
	resources['ffe.ee.myProfile.profile.startApplication.link.chooseState'] = 'Choose a different state.';
	resources['ffe.ee.myProfile.profile.startApplication.current.status'] = 'Status&#58;';
	resources['ffe.ee.myProfile.profile.invalid.heading'] = 'View inactive applications';
	resources['ffe.ee.myProfile.profile.startApplication.description'] = 'You don&#39;t need to finish making changes to your application all at once&#46; You can begin the process and stop at any point&#46; add all the text here&#46;';
	resources['ffe.ee.myProfile.profile.startApplication.list1.family'] = 'Other family members';
	resources['ffe.ee.myProfile.profile.startApplication.notAResident'] = 'Not a resident of [state]?';
	resources['ffe.ee.myProfile.profile.startApplication.resident'] = 'Resident&#63;';
	resources['ffe.ee.myProfile.profile.startApplication.current.heading2'] = 'Individual &amp; Family Coverage';
	resources['ffe.ee.myProfile.profile.startApplication.current.heading1'] = '<%=year%> <%=state%> application for';
	resources['ffe.ee.myProfile.profile.startApplication.heading3'] = 'You may need&#58;';
	resources['ffe.ee.myProfile.profile.startApplication.heading2'] = 'You can apply for any of these people on this same application&#44; even if they already have health insurance now&#58;';
	resources['ffe.ee.myProfile.selectApplication'] = 'Select application';
	resources['ffe.ee.myProfile.profile.startApplication.list2.items2'] = 'Social Security numbers &#40;if they&#39;re available&#41; for the people who want coverage';
	resources['ffe.ee.myProfile.profile.startApplication.list2.items1'] = 'Names&#44; birth dates&#44; and income information for your family';
	resources['ffe.ee.myProfile.profile.current.status'] = 'Status&#58;';
	resources['ffe.ee.myProfile.profile.startApplication.button.beginApplication'] = 'NEXT';
	resources['ffe.ee.myProfile.profile.startApplication.change.state'] = 'Select your state';
	resources['ffe.ee.myProfile.profile.startApplication.hidden.selectApplication'] = 'Label for the select';
	resources['ffe.ee.myProfile.profile.startApplication.list1.you'] = 'Yourself';
	resources['ffe.ee.myProfile.profile.startApplication.change.description'] = 'Coverage through the Marketplace is state-specific. Individuals and families must apply through the state where they live.';
	resources['ffe.ee.myProfile.profile.startApplication.button.go'] = 'Go';
	resources['ffe.ee.myProfile.profile.current.id'] = 'ID#:';
	...
	resources['ffe.ee.myAccount.employerAccountSettings.employerPrimaryMailing.addressLine2'] = 'Business address line 2';
	resources['ffe.ee.myAccount.employerAccountSettings.employerPrimaryMailing.addressLine1'] = 'Business address line 1';
	...
	resources['ffe.ee.myAccount.employerAccountSettings.employerSecondaryPhone.extension'] = 'Ext.';
	...
	resources['ffe.ee.myAccount.employerAccountSettings.success'] = 'Success! Your changes have been saved';
	...
	resources['ffe.ee.myAccount.coverage.menu.planSponsoredCoverage'] = 'Plans & Employer-sponsored Coverage';
	...
	resources['ffe.ee.myAccount.coverage.menu.contactInformation'] = 'Contact information';
	...
	resources['ffe.ee.myAccount.employerApplicationDetails.agentBroker.npnNumber'] = 'NPN number';
	...
	resources['ffe.ee.myAccount.employerAccountSettings.employerPrimaryPhone.extension'] = 'Ext.';
	...
	resources['ffe.ee.myAccount.employerAccountSettings.employerPrimaryMailing.h2'] = 'Mailing Address';
	...
	resources['ffe.ee.myAccount.employerApplicationDetails.doingBusiness.h2'] = 'Doing business as';
	...
	resources['ffe.ee.myAccount.employerAccountSettings.failure'] = 'Failure! Your changes have not been saved';
	...
	resources['ffe.ee.myAccount.employerApplicationDetails.employerApplicationDetails.h2'] = 'Business information';
	resources['ffe.ee.myAccount.employerApplicationDetails.employerApplicationDetails.h1'] = 'Application Details';
	...
	resources['ffe.ee.myAccount.employerApplicationDetails.employerApplicationDetails.submitted'] = 'Submitted:';
	...
	resources['ffe.ee.myAccount.employerAccountSettings.businessTitle.h2'] = 'Title';
	resources['ffe.ee.myAccount.idProofing.verified.pageTitle'] = 'Identity verified';
	resources['ffe.ee.myAccount.employerAccountSettings.employerPrimaryMailing.zipCodeFormat'] = 'XXXXX-XXXX';
	...
	resources['ffe.ee.myAccount.employerApplicationDetails.businessAddress.h2'] = 'Business address';
	...
	resources['ffe.ee.myAccount.employerBusiness.dropDownOptions.foreignGovt'] = 'Foreign government';
	...
	resources['ffe.ee.myAccount.idProofing.results.description2Start'] = 'You won&#39;t be able to start your application for health coverage until your identity is verified.';
	...
	resources['ffe.ee.myAccount.employerApplicationDetails.employeeAgentBroker.h2'] = 'EIN';
	...
	resources['ffe.ee.myAccount.removalReason.dropDownOptions.terminatedEmployee'] = 'Terminated Employee';
	...
	resources['ffe.ee.myAccount.employerStatus.dropDownOptions.fullTime'] = 'Full-time';
	...
	resources['ffe.ee.myAccount.employerAccountSettings.ownerName.h2'] = 'Name';
	...
	resources['ffe.ee.myAccount.employerBusiness.dropDownOptions.privateSector'] = 'Private Sector';
	...
	resources['ffe.ee.myAccount.employerAccountSettings.employerPrimaryPhone.label'] = 'Phone Number';
	...
	resources['ffe.ee.myAccount.employerBusiness.dropDownOptions.Select'] = 'Select';
	...
	resources['ffe.ee.myAccount.employerStatus.dropDownOptions.partTime'] = 'Part-time';
	...
	resources['ffe.ee.myAccount.coverage.menu.manageEmployees'] = 'Manage employees';
	...
	resources['ffe.ee.myAccount.employerAccountSettings.employerEmail.visitMyProfileLink'] = 'Visit "My Profile" to change the email address associated with your Marketplace account.';
	...
	resources['ffe.ee.myAccount.employerApplicationDetails.agentBroker.actions'] = 'Actions';
	...
	resources['ffe.ee.myAccount.employerAccountSettings.employerSecondaryPhone.h2'] = 'Secondary Phone';
	...
	resources['ffe.ee.myAccount.employerAccountSettings.employerPrimaryMailing.city'] = 'City';
	...
	resources['ffe.ee.myAccount.employerApplicationDetails.employerApplicationDetails.description'] = 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Cras rhoncus vehicula lorem, non posuere felis mattis non. Aenean nisl metus, pellentesque a tristique nec, accumsan at turpis.';
	...
	resources['ffe.ee.myAccount.employerBusiness.dropDownOptions.stateGovt'] = 'State/local government';
	...
	resources['ffe.ee.myAccount.employerStatus.dropDownOptions.owner'] = 'Owner/business partner';
	...
	resources['ffe.ee.myAccount.employerApplicationDetails.employerApplicationDetails.updated'] = 'Updated:';
	...
	resources['ffe.ee.myAccount.employerAccountSettings.employerPrimaryPhone.h2'] = 'Primary Phone';
	resources['ffe.ee.myAccount.idProofing.results.heading3CallNow'] = 'Please call the Help Desk now&#46;';
	resources['ffe.ee.myAccount.employerAccountSettings.businessTitle.label'] = 'Company Name';
	...
	resources['ffe.ee.myAccount.employerApplicationDetails.federalEIN.h2'] = 'Federal Employer Identification Number (EIN)';
	...
	resources['ffe.ee.myAccount.employerStatus.dropDownOptions.retired'] = 'Retired';
	...
	resources['ffe.ee.myAccount.employerBusiness.dropDownOptions.church'] = 'Church/church-affiliate';
	...
	resources['ffe.ee.myAccount.employerApplicationDetails.doingBusiness.labelDoingBusiness'] = 'Doing business as';
	...
	resources['ffe.ee.myAccount.removalReason.dropDownOptions.employeeSwitched'] = 'Employee switched to Part Time';
	...
	resources['ffe.ee.myAccount.employerAccountSettings.employerSecondaryPhone.label'] = 'Phone Number';
	resources['ffe.ee.myAccount.employerApplicationDetails.agentBroker'] = 'Agent/Broker';
	...
	resources['ffe.ee.myAccount.employerAccountSettings.employerPrimaryMailing.zipCode'] = 'Zip Code';
	...
	resources['ffe.ee.myAccount.employerApplicationDetails.businessName.h2'] = 'Business name';
	...
	resources['ffe.ee.myAccount.employerApplicationDetails.businessName.label'] = 'Business name';
	...
	resources['ffe.ee.myAccount.employerApplicationDetails.agentBroker.agentBrokerButton'] = 'Add New Agent or Broker';
	...
	resources['ffe.ee.myAccount.addEmployeeModal,selectRoster.previous'] = 'Previously Uploaded Roster';
	resources['ffe.ee.myAccount.employerApplicationDetails.businessType.label'] = 'Business type';
	...
	resources['ffe.ee.myAccount.employerAccountSettings.employerPrimaryMailing.state'] = 'State';
	...
	resources['ffe.ee.myAccount.employerStatus.dropDownOptions.spouse'] = 'Spouse of owner';
	...
	resources['ffe.ee.myAccount.employerApplicationDetails.employerApplicationDetails.appFor'] = 'Appplication For:';
	...
	resources['ffe.ee.myAccount.employerApplicationDetails.businessType.h2'] = 'Business type';
	...
	resources['ffe.ee.myAccount.employerApplicationDetails.businessAddress.label'] = 'Business address';
	...
	resources['ffe.ee.myAccount.employerApplicationDetails.federalEIN.label'] = 'EIN';
	...
	resources['ffe.ee.myAccount.employerApplicationDetails.agentBroker.h2'] = 'Agent/Broker Information';
...
var MyProfile_ProfileBBModel = FFEModel.extend({

	pageName:"myProfile",
	defaults : { },
	//urlRoot: environment+"/ee-rest/auth/"+tenantId+"/" +locale +"/myProfile",
	idAttribute : "userName",
	resources : resources,
	role : null
});

var myProfileProfileBBModel = new MyProfile_ProfileBBModel(newMyProfileModel());
//
// Attention: This file is generated once and can be modified by hand
// Generated by: pageBBmodel.js.vsl in andromda-backbone-js-ui cartridge.
//
...
// Create the ProfileBBModel Model
var MyProfile_UpdateRegisteredStateBBModel = FFEModel.extend({

	pageName:"myProfile",
	defaults : { },
	url: environment+"/ee-rest/auth/"+tenantId+"/"+locale+"/EeAccount/updateSystemUserRegisteredState/ffm",
	idAttribute : "systemUserLoginName",
	resources : resources,
	role : null
});

var myProfileUpdateRegisteredStateBBModel = new MyProfile_UpdateRegisteredStateBBModel(updateRegisteredState());
//
// Attention: This file is generated once and can be modified by hand
// Generated by: pageBBmodel.js.vsl in andromda-backbone-js-ui cartridge.
//
...
// Create the ProfileBBModel Model
var MyProfile_GetSystemUserInfoBBModel = CommonValidationBBModel.extend({
...
var myProfileGetSystemUserInfoBBModel = new MyProfile_GetSystemUserInfoBBModel(getSystemUserInfo());
...
var myProfileSystemUser_updateSystemUserEmailBBModel = CommonValidationBBModel.extend({

	pageName:"myProfile",
	defaults : { },
	 
	url: environment+"/ee-rest/auth/ffe/"+locale+"/EeAccount/updateSystemUserEmailAddress/ffm",
	idAttribute : "ffm",
	resources : resources,
	role : null
}); 
var myProfileSystemUserUpdateSystemUserEmailBBModel = new myProfileSystemUser_updateSystemUserEmailBBModel(initializeSystemUserUpdateEmail());
var myProfileSystemUser_updateSystemUserPhoneNumberBBModel = CommonValidationBBModel.extend({

	pageName:"myProfile",
	defaults : { },
	 
	url: environment+"/ee-rest/auth/ffe/"+locale+"/EeAccount/updateSystemUserPhoneNumber/ffm",
	idAttribute : "ffm",
	resources : resources,
	role : null
}); 
var myProfileSystemUserUpdateSystemUserPhoneNumberBBModel = new myProfileSystemUser_updateSystemUserPhoneNumberBBModel(initializeSystemUserUpdatePhoneNumber());
var myProfileEEAccount_saveTermsAndConditionsBBModel = CommonValidationBBModel.extend({

	pageName:"myProfile",
	defaults : { },
	 
	url : environment+"/ee-rest/auth/"+tenantId+"/"+locale+"/EeAccount/saveAcceptedTermsOfservice/ffm",
	idAttribute : "systemUserId",
	resources : resources,
	role : null
}); 
var myProfileEEAccountSaveTermsAndConditionsBBModel = new myProfileEEAccount_saveTermsAndConditionsBBModel(initializeTermsConditionModel());
var myProfileEIDMIntegration_updateEmailBBModel = CommonValidationBBModel.extend({

	pageName:"myProfile",
	defaults : { },
	 
	url: environment+"/ee-rest/auth/"+tenantId+"/" +locale +"/MyAccountEIDMSecuredIntegration/updateEmail/ffm",
	idAttribute : "userName",
	resources : resources,
	role : null
}); 
var myProfileEIDMIntegrationUpdateEmailBBModel = new myProfileEIDMIntegration_updateEmailBBModel(initializeEIDMIntegrationUpdateEmail());
var myProfileEIDMIntegration_updatePasswordBBModel = CommonValidationBBModel.extend({

	pageName:"myProfile",
	defaults : { },
	 
	url: environment+"/ee-rest/auth/"+tenantId+"/" +locale +"/MyAccountEIDMSecuredIntegration/updatePassword/ffm",
	idAttribute : "userName",
	resources : resources,
	role : null
}); 
var myProfileEIDMIntegrationUpdatePasswordBBModel = new myProfileEIDMIntegration_updatePasswordBBModel(initializeEIDMIntegrationUpdatePasswordModel());
var myProfileEIDMIntegration_fetchEIDMValidationsBBModel = CommonValidationBBModel.extend({

	pageName:"myProfile",
	defaults : { },
	 
	url : environment+"/ee-rest/"+tenantId+"/" +locale +"/MyAccountEIDMUnsecuredIntegration/fetchEIDMValidations/ffm",
	urlRoot: environment+"/ee-rest/"+tenantId+"/" +locale +"/MyAccountEIDMUnsecuredIntegration/fetchEIDMValidations/ffm",
	idAttribute : "userName",
	resources : resources,
	role : null
}); 
var myProfileEIDMIntegrationfetchEIDMValidationsBBModel = new myProfileEIDMIntegration_fetchEIDMValidationsBBModel();
var myProfileEIDMIntegration_fetchSecurityQuestionsEIDMBBModel = CommonValidationBBModel.extend({
...
var myProfileEIDMIntegrationFetchSecurityQuestionsEIDMBBModel = new myProfileEIDMIntegration_fetchSecurityQuestionsEIDMBBModel();
var myProfileEIDMIntegration_updateSecurityQuestionsEIDMBBModel = CommonValidationBBModel.extend({

	pageName:"myProfile",
	defaults : { },

	url: environment+"/ee-rest/auth/"+tenantId+"/"+locale+"/MyAccountEIDMSecuredIntegration/updateSecurityQuestions/ffm",
	idAttribute : "userName",
	resources : resources,
	role : null
}); 
var myProfileEIDMIntegrationUpdateSecurityQuestionsEIDMBBModel = new myProfileEIDMIntegration_updateSecurityQuestionsEIDMBBModel(updateEIDMSecurityQuestions());
var myProfileEIDMIntegration_fetchUserSecurityQuestionsEIDMBBModel = CommonValidationBBModel.extend({

	pageName:"myProfile",
	defaults : { },
	 
	urlRoot: environment+"/ee-rest/global/" +locale+ "/MyAccountEIDMUnsecuredIntegration/fetchSecurityQuestions",
	idAttribute : "userName",
	resources : resources,
	role : null
}); 
var myProfileEIDMIntegrationUserFetchSecurityQuestionsEIDMBBModel = new myProfileEIDMIntegration_fetchUserSecurityQuestionsEIDMBBModel();
var myProfileEIDMIntegration_updatePhoneNumberBBModel = CommonValidationBBModel.extend({

	pageName:"myProfile",
	defaults : { },
	 
	url: environment+"/ee-rest/auth/"+tenantId+"/"+locale+"/MyAccountEIDMSecuredIntegration/updatePhoneNumber/ffm",
	idAttribute : "userName",
	resources : resources,
	role : null
}); 
var myProfileEIDMIntegrationUpdatePhoneNumberBBModel = new myProfileEIDMIntegration_updatePhoneNumberBBModel(initializeEIDMIntegrationUpdatePhoneNumberModel());
var myProfileEIDMIntegration_updateHomeAddressEIDMBBModel = CommonValidationBBModel.extend({

	pageName:"myProfile",
	defaults : { },
	 
	url: environment+"/ee-rest/auth/global/" +locale +"/MyAccountEIDMSecuredIntegration/updateAddress/ffm",
	idAttribute : "userName",
	resources : resources,
	role : null
}); 
var myProfileEIDMIntegrationUpdateHomeAddressEIDMBBModel = new myProfileEIDMIntegration_updateHomeAddressEIDMBBModel(initializeEIDMIntegrationUpdateAddressModel());
var myProfileSystemUser_updateSystemUserAddressBBModel = CommonValidationBBModel.extend({

	pageName:"myProfile",
	defaults : { },
	 
	url: environment+"/ee-rest/auth/ffe/"+locale+"/EeAccount/updateSystemUserAddress/ffm",
	idAttribute : "ffm",
	resources : resources,
	role : null
}); 
var myProfileSystemUserUpdateSystemUserAddressBBModel = new myProfileSystemUser_updateSystemUserAddressBBModel(initializeSystemUserUpdateAddress());
//
// Attention: This file is generated once and can be modified by hand
// Generated by: pageBBmodel.js.vsl in andromda-backbone-js-ui cartridge.
//
...
// Create the ProfileBBModel Model
var MyProfile_fetchUserInfoBBModel = CommonValidationBBModel.extend({

	pageName:"myProfile",
	defaults : { },
	url: environment+"/ee-rest/auth/"+tenantId+"/" +locale +"/MyAccountEIDMSecuredIntegration/fetchUserInfo/ffm",
	idAttribute : "ffm",
	resources : resources,
	role : null
});

var myProfileFetchUserInfoBBModel = new MyProfile_fetchUserInfoBBModel(fetchUserInfoProfile());
//
// Attention: This file is generated once and can be modified by hand
// Generated by: pageBBmodel.js.vsl in andromda-backbone-js-ui cartridge.
//
...
// Create the ProfileBBModel Model
var MyProfileCCRIntegration_updateCCRInfoBBModel = CommonValidationBBModel.extend({

	pageName:"myProfile",
	defaults : { },
	url: environment+"/ee-rest/auth/global/" +locale +"/CallCenterRepresentative/findAndUpdateCCR",
	idAttribute : "userId",
	resources : resources,
	role : null
});

var myProfileCCRIntegrationUpdateCCRInfoBBModel = new MyProfileCCRIntegration_updateCCRInfoBBModel(fetchCCRUserInfoProfile());
//
// Attention: This file is generated once and can be modified by hand
// Generated by: pageBBmodel.js.vsl in andromda-backbone-js-ui cartridge.
//
...
// Create the ProfileBBModel Model
var MyProfile_fetchApplicationByPersonID = CommonValidationBBModel.extend({

	pageName:"myProfile",
	defaults : { },
	url: environment+"/ee-rest/auth/global/"+locale+"/CallCenterRepresentative/fetchAllApplicationsForPersonId",
	idAttribute : "id",
	resources : resources,
	role : null
});

var myProfileFetchApplicationByPersonIDModel = new MyProfile_fetchApplicationByPersonID(fetchAllApplicationsForPersonId());
//
// Attention: This file is generated once and can be modified by hand
// Generated by: pageBBmodel.js.vsl in andromda-backbone-js-ui cartridge.
//
...
// Create the ProfileBBModel Model
var MyProfile_fetchApplicationByApplicationID = CommonValidationBBModel.extend({

	pageName:"myProfile",
	defaults : { },
	url: environment+"/ee-rest/auth/"+tenantId+"/"+locale+"/CallCenterRepresentative/fetchSlimInsuranceApplicationById",
	idAttribute : "id",
	resources : resources,
	role : null
});

var myProfileFetchApplicationByApplicationIDModel = new MyProfile_fetchApplicationByApplicationID(fetchApplicationByApplicationID());
...
// myProfile
// gov.hhs.cms.ffe.ee.web.myProfile
// web
//
var MyProfile_ProfileBBView = FFEView.extend({
	...
	model : myProfileProfileBBModel,
	updatePasswordModel : myProfileEIDMIntegrationUpdatePasswordBBModel,
	updateEmailModel : myProfileEIDMIntegrationUpdateEmailBBModel,
	updatePhoneNumberModel : myProfileEIDMIntegrationUpdatePhoneNumberBBModel,
	updateSecurityQuestionsModel : myProfileEIDMIntegrationUpdateSecurityQuestionsEIDMBBModel,
	fetchValidationModel : myProfileEIDMIntegrationfetchEIDMValidationsBBModel,
	securityQuestionsModel : myProfileEIDMIntegrationFetchSecurityQuestionsEIDMBBModel,
	userSecurityQuestionsModel : myProfileEIDMIntegrationUserFetchSecurityQuestionsEIDMBBModel,
	updateAddressModel : myProfileEIDMIntegrationUpdateHomeAddressEIDMBBModel,
	updateRegisteredStateModel : myProfileUpdateRegisteredStateBBModel,
	getSystemUserInfoModel : myProfileGetSystemUserInfoBBModel,
	updatePersonFromEIDMModel : myAccountUpdatePersonFromEIDMBBModel,
	updateSystemUserEmailModel : myProfileSystemUserUpdateSystemUserEmailBBModel,
	fetchUserInfoModel : myProfileFetchUserInfoBBModel,
	getSecureRedirectInfoModel : getSecureRedirectInfoBBModel,
	notificationsCollection : myAccountAccountNotificationsBBCollection,
	fetchCCRSystemUserInfoModel: myProfileCCRIntegrationUpdateCCRInfoBBModel,
	fetchApplicationByPersonIDModel: myProfileFetchApplicationByPersonIDModel,
	fetchApplicationByApplicationIDModel: myProfileFetchApplicationByApplicationIDModel,
	//TODO: add model for CCR service to see if user is CCR
	
	// Underscore.js template variables points to the template in the XHTML
	// file. There can be more than one template.
	level1Template : _.template($('#profileLevel1Template').html()),
	level2Template : _.template($('#profileLevel2Template').html()),
	suffixDropDownUSTemplate : _.template($('#suffixDropDownUSTemplate').html()),
	updateSecurityQuestionsPasswordModalTemplate : _.template($('#updateSecurityQuestionsPasswordModalTemplate').html()),
	profileDisplaySecurityQuestionTemplate : _.template($('#profileDisplaySecurityQuestionTemplate').html()),
	stateNonAbbreviatedDropDownOptionsTemplate : _.template($('#stateNonAbbreviatedDropDownOptionsTemplate').html()),
	stateNonAbbreviatedDropDownOptionsTemplateFFM : _.template($('#stateNonAbbreviatedDropDownOptionsTemplateFFM').html()),
	regularNotificationTemplate : _.template($('#regularNotificationTemplate').html()),
	profileSuccesUpdatingTemplate : _.template($('#profileSuccesUpdatingTemplate').html()),
	profileErrorUpdatingTemplate : _.template($('#profileErrorUpdatingTemplate').html()),
	profileSubscribeTemplate : _.template($('#profileSubscribeTemplate').html()),
	//idProofed templates
	identityNotVerifiedTemplate : _.template($('#identityNotVerifiedTemplate').html()),
	identitVerificationPendingTemplate : _.template($('#identitVerificationPendingTemplate').html()),
	identityVerifiedTemplate : _.template($('#identityVerifiedTemplate').html()),
	identityUnderESDReviewTemplate : _.template($('#identityUnderESDReviewTemplate').html()),
	identityUnderESDReviewNeedMoreDocsTemplate : _.template($('#identityUnderESDReviewNeedMoreDocsTemplate').html()),
	identitytoUpdateCallTemplate : _.template($('#identitytoUpdateCallTemplate').html()),
	timeoutErrorTemplate : _.template($('#timeoutErrorTemplate').html()),
	...
	initialize : function() {
		...
		_.bindAll(this, 'render', 'refreshTemplate', 'editArea', 'saveEditArea', 'cancelEditArea',
				'updatePassword', 'setUpdatePasswordModelInfo', 'updateEmail','setUpdateEmailInfo',
				'initializeValidation', 'initialFetch','fetchBasicValidationRules', 'updateArea',
				'fetchSecurityQuestions', 'initRenderSecurityQuestions',
				'changeSecurityQuestions', 'updateSecurityQuestions', 'renderDisplaySecurityQuestions',
				'updatePhoneNumber', 'setHomeAddress', 'updateHomeAddress','updateState','setUpdateStateModelInfo',
				'fetchGetSystemUserInfo','updateEmailDisplay','updateStateDisplayed', 'updateSystemUserEmail',
				'setSystemUserEmail', 'setUserInfoToProfileModel', 'setGetSystemUserInfoToProfileModel',
				'spanishRegex', 'englishRegex', 'setStateLink','fetchUserInfo','appendUserLevel', 'checkIDProofStatus', 'idProofNow',
				'idProofStatusNotVerified', 'checkESDStatus', 'savePersonFromEIDM', 'setPersonFromEIDM', 'idProofUploadDocs','fetchCCRUserInfoProfile','fetchApplicationByApplicationID','fetchApplicationsByPersonID','fetchUserInfoForAgentBroker',
				'showTimoutError');

		
		this.model.bind('refreshProfileTemplates', this.refreshTemplate);
		this.model.bind('fetchUserInfo', this.fetchUserInfo);
		this.model.bind('renderDisplaySecurityQuestions', this.renderDisplaySecurityQuestions);
		this.model.bind('setUserInfoToProfileModel', this.setUserInfoToProfileModel);
		this.model.bind('fetchGetSystemUserInfo', this.fetchGetSystemUserInfo);
		this.model.bind('fetchCCRUserInfoProfile', this.fetchCCRUserInfoProfile);
		this.model.bind('fetchApplicationsByPersonID', this.fetchApplicationsByPersonID);
		this.model.bind('fetchApplicationByApplicationID', this.fetchApplicationByApplicationID);
		...
		this.render();
		if(ffeCCRUser === 'true') {
			if(!isEmpty(ffeCCRUserID)){
				this.fetchCCRUserInfoProfile();
			}
		}
		this.initialFetch();
		var referrer = getUrlVars();
		if(referrer.hasOwnProperty('to')) {
			if(referrer.to === 'settings') {
				this.to = 'settings';
			}
			else{
				this.to = '';
	...
	events : {
		'click .edit' : 'editArea',
		'click .save' : 'saveEditArea',
		"change .securityQuestions" : "changeSecurityQuestions",
		"click .idProofNow" : "idProofNow",
		"click .idProofUploadDocs" : "idProofUploadDocs",
		'click .cancel' : 'cancelEditArea'
	...
	refreshTemplate : function()
	{
		...
		var quickAnswers = parseCookie(COOKIE_QUICK_ANSWERS),
			...
			stateNonAbbr = "",
			stateLiveInNonAbbr="",
			stateLiveIn = this.model.get('registeredStateCode'),
			addressState = this.model.get('state'),
		...
		{
			//for state you live in
			if(stateLiveIn === stateData[x].stateCode) {
				stateLiveInNonAbbr = stateData[x].stateName;
			}	
			//for updated address state
			if(addressState === stateData[x].stateCode) {
				stateNonAbbr = stateData[x].stateName;
			}
		}
		
		var phoneNumber = this.model.get('phoneNumber');
		var phoneNumberButton="";
		if(isEmpty(phoneNumber)){
			phoneNumber = this.resources['ffe.ee.myAccount.profile.homeAddress.noneRecord'];
			phoneNumberButton = this.resources['ffe.ee.shared.buttton.add'];
			buttonPhoneClass = 'btn-info';
		}
		else{
			phoneNumberButton = this.resources['ffe.ee.shared.button.edit'];
			phoneNumber = this.model.get('phoneNumber');
			buttonPhoneClass = 'btn-leftArrow';
			
		}
		
		var addressButton = "";
		var address = this.model.get('addressLine1');
		if(!isEmpty(address)){
			addressButton = this.resources['ffe.ee.shared.button.edit'];
			address = this.model.get('addressLine1')+ "<br />";
			if(!isEmpty(this.model.get('addressLine2'))) {
				address += this.model.get('addressLine2')+"<br />";
			}
			address += this.model.get('city')+", "+this.model.get('state')+ " " + this.model.get('zipCode');
			buttonAddressClass = 'btn-leftArrow';
		}
		else{
			addressButton = this.resources['ffe.ee.shared.buttton.add'];
			address = this.resources['ffe.ee.myAccount.profile.homeAddress.noneRecord'];
			buttonAddressClass = 'btn-info';
		}
		var addressLine1 = this.model.get('addressLine1');
		var addressLine2 = this.model.get('addressLine2');
		var city = this.model.get('city');
		var zipCode = this.model.get('zipCode');
		
		emailButton = (!isEmpty(email)) ? this.resources['ffe.ee.shared.button.edit'] : this.resources['ffe.ee.shared.buttton.add'];
		buttonEmailClass = (!isEmpty(email)) ? 'btn-leftArrow' : 'btn-info';
		
		$('#headerUserName').text(this.model.get('firstName'));
		$('.usersName').html("<strong>"+fullName+"</strong>");
		
		this.$el.empty();
		this.$el.append(this.level1Template({
			"memberFirstName" : this.model.get('firstName'),
			"memberMiddleName" : this.model.get('middleName'),
			"memberLastName" : this.model.get('lastName'),
			...
			"city" : city,
			"zipCode" : zipCode,
			"memberState" : stateLiveInNonAbbr,
			'buttonEmailClass' : buttonEmailClass,
			'buttonAddressClass' : buttonAddressClass,
			'buttonPhoneClass' : buttonPhoneClass
		}));
		$("#primaryPhoneEdit").mask("9999999999");
		$("#homeAddressZipCode").mask("99999?-9999");
		
		$('#myProfileSuffixContainer').empty();
		$('#myProfileSuffixContainer').append(this.suffixDropDownUSTemplate({
			'idToUse' : 'myProfileSuffix',
			...
			'forToUse' : 'myProfileSuffix',
			'isRequired' : false,
			'nameToUse' : null
		}));
		
		$('#myProfileSuffix').val(this.model.get('suffix'));
		
		$('#stateDropDownOptions').empty();
		$('#stateDropDownOptions').append(this.stateNonAbbreviatedDropDownOptionsTemplateFFM({
			"idToUse" : "stateLiveInDropDown"
			
		}));
		if(!isEmpty(stateLiveInNonAbbr)){
			$('#stateLiveInDropDown').val(stateLiveInNonAbbr);
		}
		$("#stateLiveInDropDown")
			.attr('data-validate', 'notBlank');
			
		$('#homeAddressStateDropDownOptions').empty();
		$('#homeAddressStateDropDownOptions').append(this.stateNonAbbreviatedDropDownOptionsTemplate({
			"idToUse" : "homeAddressState"
			
		}));
		if(!isEmpty(stateNonAbbr)){
			$('#homeAddressState').val(stateNonAbbr);
		}
		$("#homeAddressState")
			.attr('data-validate', 'notBlank EIDMState');
		
		this.initializeValidation();
		this.renderDisplaySecurityQuestions();
		this.initRenderSecurityQuestions();
		this.appendUserLevel();
		
		$('input', '#myProfilePage').customInput();
	...
	initialFetch : function() {
		blockUIForProfile();
		this.getSecureRedirectInfo();		
	},
	
	getSecureRedirectInfo : function(){
		var $this = this;
		...
		this.getSecureRedirectInfoModel.fetch({
			success : function(model, response) {
				...
				var agentBroker = checkForAgentBroker();

				if(agentBroker === true)
				{
					console.log("success");
					console.log(response);
					$this.fetchUserInfoForAgentBroker();
				}
				else
				{
					if(ffeCCRUser ==='true')
					{
						$this.model.trigger("fetchApplicationsByPersonID");
					}else{
						$this.model.trigger("fetchUserInfo");
						$this.fetchBasicValidationRules();
					}
				}
			},
			error : function(model, response) {
				//Always redirect consumer
			}
		});
		
	},

   fetchUserInfoForAgentBroker : function(){
		var $this = this,
			systemUserLoginName = ffeUserName,
			routes = router;
//		$.unblockUI();
//		$this.model.trigger("refreshProfileAgentBrokerSearchTemplates");
//		router.navigate("agentSearch", { trigger: true });
			
		this.getSystemUserInfoModel.set({'systemUserLoginName' : systemUserLoginName});
		this.getSystemUserInfoModel.fetch({
			success: function (model, response) {
				console.log("successful agent broker fetch user info");
				$.unblockUI();
				$this.model.trigger("refreshProfileAgentBrokerSearchTemplates");
				router.navigate("agentSearch", { trigger: true });
			},
			error: function (model, response) {
				$.unblockUI();
				console.log("error in fetch agent broker user info");
			}
		});
	...
	fetchUserInfo : function() {
		...
		if(!isEmpty(username)) {
			this.fetchUserInfoModel.set({'userName': 'ffm'});
			this.fetchUserInfoModel.fetch({
				success : function(model, response) {
					$this.model.trigger('setUserInfoToProfileModel');
					$this.model.trigger('fetchGetSystemUserInfo');
					$this.model.trigger('refreshProfileTemplates');
					$.unblockUI();
	...
	setUserInfoToProfileModel : function() {
		this.model.set({'firstName' : this.fetchUserInfoModel.get('firstName')});
		this.model.set({'lastName' : this.fetchUserInfoModel.get('lastName')});
		this.model.set({'middleName' : this.fetchUserInfoModel.get('middleName')});
		this.model.set({'suffix' : this.fetchUserInfoModel.get('suffix')});
		this.model.set({'email' : this.fetchUserInfoModel.get('email')});
		this.model.set({'phoneNumber' : this.fetchUserInfoModel.get('phoneNumber')});
		this.model.set({'addressLine1' : this.fetchUserInfoModel.get('addressLine1')});
		this.model.set({'addressLine2' : this.fetchUserInfoModel.get('addressLine2')});
		this.model.set({'city' : this.fetchUserInfoModel.get('city')});
		this.model.set({'state' : this.fetchUserInfoModel.get('state')});
		this.model.set({'zipCode' : this.fetchUserInfoModel.get('zipCode')});
		this.model.set({'userLevel' : this.fetchUserInfoModel.get('userLevel')});
		this.model.set({'language' : this.fetchUserInfoModel.get('language')});
		this.model.set({'userName' : this.fetchUserInfoModel.get('userName')});
	},
	...
	renderDisplaySecurityQuestions : function() {
		var questions = this.userSecurityQuestionsModel.get('securityQuestions');
		
		$('#displaySecurityQuestions').empty();
		
		if (!isEmpty(questions)) {
			for(var x = 0; x < questions.length; x++) {
				$('#displaySecurityQuestions').append(this.profileDisplaySecurityQuestionTemplate({
	...
	initRenderSecurityQuestions : function() {
		var securityQs = this.securityQuestionsModel.get('securityQuestions'),
			options = '';
		$('.securityQuestions option', '#myProfilePage').remove();
		
		if(!isEmpty(securityQs)) {
			//loop through the four inputs
			...
			for(var j = 0; j < 3; j++) {
				...
				$('#securityqt'+j).append(options);
			}
		}
	},
	
	changeSecurityQuestions : function() {
		filterSecurityQuestions(this.securityQuestionsModel, 'myProfilePage', this.resources['ffe.ee.shared.select']);
	},
	
	initializeValidation : function() {
		var validations = this.fetchValidationModel.get('validations'),
			validationsAttr,
			validationMessage;
			
		FFM.defaultValidatorRules.notBlank = ["^(?!\\s*$).+", this.resources['ffe.ee.shared.validation.notBlank']];
		//TODO: maybe modify the below to use a similar method isntead.
		...
		if($("#myProfilePage").find('.validatorFormGroup').length === 0) {
			if(!isEmpty(validations)) {
				...
				for(var i = 0; i < validations.length; i++) {
					if(!isEmpty(validations[i].fieldName) && !isEmpty(validations[i].regularExpression)) {
						...
						if(!FFM.defaultValidatorRules.EIDMUserNotEmail)
						{
							validationMessage = this.resources['ffe.ee.myAccount.notValidError']+' '+this.resources['ffe.ee.myAccount.label.userName'];
							FFM.defaultValidatorRules.EIDMUserNotEmail = ["^[a-zA-Z0-9]{0,}[^\@]{0}[^a-zA-Z0-9]{0,}[^\.]{0}[a-zA-Z0-9]{0}$", validationMessage];
						}
					}
				}
				var nameValidator = new FFM.FormValidator($("#nameValidationContainer"), $("#nameConfirm"));
				var	passwordValidator = new FFM.FormValidator($("#passwordValidationContainer"), $("#passwordConfirm"));				
				var emailValidator = new FFM.FormValidator($("#emailValidationContainer"), $("#emailConfirm"));				
				var	primaryPhoneValidator = new FFM.FormValidator($("#primaryPhoneValidationContainer"), $("#primaryPhoneConfirm"));
				var	stateLiveInValidator = new FFM.FormValidator($("#stateLiveInContainer"), $("#saveStateLiveIn"));
				var	securityQuestionsValidator = new FFM.FormValidator($("#saveSecurityQuestionsContainer"), $("#saveSecurityQuestions"));
				var	addressValidator = new FFM.FormValidator($("#addressValidationContainer"), $("#addressConfirm"));
			}
		}
	},
	...
	spanishRegex : function( validationsAttr, validations, validationMessage ) {
		...
		if(validationsAttr === 'EIDMPassword') {
			...
			FFM.defaultValidatorRules[validationsAttr] = [validations.regularExpression, validationMessage];
			validations.regularExpression = "^((?!(_|,|'|�)).)*$";
			FFM.defaultValidatorRules.noCommasAndOther1 = [validations.regularExpression, validationMessage];
		}
			...
			FFM.defaultValidatorRules[validationsAttr] = [validations.regularExpression, validationMessage];
			validations.regularExpression = "^((?!(_|,|'|�)).)*$";
			FFM.defaultValidatorRules.noCommasAndOther2 = [validations.regularExpression, validationMessage];
		}
	...
	fetchBasicValidationRules : function() {
		var $this = this;
		if(false) { // spare EIDM right now
		this.fetchValidationModel.fetch({
			success : function(model, response) {
				$this.initializeValidation();
		 ...
		 var validations = [{"csrf":null,"regularExpression":"^[a-zA-Z0-9_]*$","fieldName":"Application ID","nullString":""},
				...
				this.fetchValidationModel.set("validations", validations);
				$this.initializeValidation();
				$this.fetchSecurityQuestions();
		}
	},
		
	fetchGetSystemUserInfo : function() {
		var $this = this,
			systemUserLoginName = ffeUserName,
			routes = router;
		...
		this.getSystemUserInfoModel.fetch({
			success : function(model, response) {
					...
					$this.setGetSystemUserInfoToProfileModel();
					$.unblockUI();
					$this.refreshTemplate();
					//$this.model.trigger('refreshProfileLOALandingTemplates');
					focusableMainContent();

					
					if(!response.systemUser.termsAccepted) 
					{
						hideUserMenuOptions();
						setTitleFromResource($this.resources['ffe.ee.myAccount.registration.TermsConditions.pageTitle']);
						$this.model.trigger('refreshTemplate');
						$this.model.trigger('refreshLogInTermsAndConditionsTemplates');
					}
					else
					{
						showUserMenuOptions();
						$this.model.trigger("refreshProfileLandingTemplates");
						if($this.to === 'settings') {
							routes.navigate("settings", {trigger: true});
						}
						else {
							routes.navigate("landingPage", {trigger: true});
						}
						$this.to = '';
					}
			...
			error : function(model, response) 
			{
				...
				try
				{
					...
					if(responseText.errors[0].errorType === 'T100')
					{
						$this.showTimoutError('myProfileNotifictionArea');
					}
				}
				catch(e)
				{
					console.log("error in fetch user info- other");
				}
				//TODO: catch other
				$.unblockUI();
				console.log("error in fetch user info");
	...
	fetchGetSystemUserInfoToUpdateSession : function() {
		var $this = this,
			systemUserLoginName = ffeUserName;
	...
	setGetSystemUserInfoToProfileModel : function(){
		this.model.set({'firstName' : this.getSystemUserInfoModel.get('systemUser').firstName});
		this.model.set({'lastName' : this.getSystemUserInfoModel.get('systemUser').lastName});
		this.model.set({'middleName' : this.getSystemUserInfoModel.get('systemUser').middleName});
		this.model.set({'suffix' : this.getSystemUserInfoModel.get('systemUser').suffix});
		this.model.set({'email' : this.getSystemUserInfoModel.get('systemUser').emailAddress});
		this.model.set({'phoneNumber' : this.getSystemUserInfoModel.get('systemUser').phoneNumber});
		//this.model.set({'addressLine1' : this.getSystemUserInfoModel.get('systemUser').addressLine1});
		//this.model.set({'addressLine2' : this.getSystemUserInfoModel.get('systemUser').addressLine2});
		//this.model.set({'city' : this.getSystemUserInfoModel.get('systemUser').city});
		//this.model.set({'state' : this.getSystemUserInfoModel.get('systemUser').state});
		this.model.set({'registeredStateCode' : this.getSystemUserInfoModel.get('systemUser').registeredStateCode});
		//this.model.set({'zipCode' : this.getSystemUserInfoModel.get('systemUser').zipCode});
		this.model.set({'userLevel' : this.getSystemUserInfoModel.get('systemUser').userLevel});
		this.model.set({'language' : this.getSystemUserInfoModel.get('systemUser').language});
		this.model.set({'systemUserIdentifier' : this.getSystemUserInfoModel.get('systemUser').systemUserIdentifier});
		this.model.set({'personIdentifier' : this.getSystemUserInfoModel.get('systemUser').personIdentifier});
		this.model.set({'userEmailConfirmationUuId' : this.getSystemUserInfoModel.get('systemUser').userEmailConfirmationUuId});
		this.model.set({'userTrackingNumber' : this.getSystemUserInfoModel.get('systemUser').userTrackingNumber});
	},
	...
	editArea : function( e ) {
		...
		if(!target.is('disabled')) {
			...
			//make all .edits inside #registrationProfilePage disabled
			$('.edit', '#myProfilePage').attr('disabled', true);
			$('.edit', '#myProfilePage').attr('aria-disabled', true);

			$('.notification', this.$el).hide();

			//hiding and showing .inner-inconstant/.inner-constant
			target.closest('.inactiveEditSection').find('.inner-inconstant').show();
			target.closest('.inactiveEditSection').children('.span6').attr('class','span8');
			target.closest('.inactiveEditSection').children('.span8').children('.notification').hide();
			target.parent().parent().find('.inner-constant').hide();
			
			//adding the .activeEditSection and removing .inactiveEditSection
			target.closest('.inactiveEditSection ').addClass('activeEditSection');
			target.closest('.activeEditSection').removeClass('inactiveEditSection');
			
			//focus to either input or select
			input = target.closest('.activeEditSection').find('input').eq(0);
			if(input.attr('id') === 'questsec0' || input.attr('id') === undefined) {
				input = target.closest('.activeEditSection').find('select').eq(0);
			}
			input.focus();
		}
	...
	saveEditArea : function( e ) {
		var target = $(e.target);
		
		$('.edit', '#myProfilePage').show();
		
		$('.edit', '#myProfilePage').attr('disabled', false);
		$('.edit', '#myProfilePage').attr('aria-disabled', false);
		
		//removing the .activeEditSection and adding .inactiveEditSection
		target.closest('.activeEditSection ').addClass('inactiveEditSection');
		target.closest('.inactiveEditSection').children('.span8').attr('class','span6');
		target.closest('.inactiveEditSection').removeClass('activeEditSection');
		
		//hide all .inner-constant inside #myProfilePage
		$('.inner-inconstant', '#myProfilePage').hide();
		$('.inner-constant', '#myProfilePage').show();
		
		//todo saveCall
		var editInputID = target.parent().parent();
		this.updateArea(editInputID);
	},
	
	updateArea : function( target ) {
		var inputID = target.find('input').eq(0).attr('id');
		var selectID = target.find('select').eq(0).attr('id');
		...
		if(!isEmpty(inputID))
		{
			switch(inputID) 
			{
				...
				case 'emailInputField':
					this.updateEmail();
					break;
				case 'securityanswer0':
					this.updateSecurityQuestions();
					break;
				case 'primaryPhoneEdit':
		...
		else if(!isEmpty(selectID)) 
		{
			if(selectID === 'stateLiveInDropDown') 
			{
				this.updateState();
				this.setStateLink(); // 7558
			}
		}
	},
	
	setStateLink : function () {
		var stateAbbr = this.getSystemUserInfoModel.get('systemUser').registeredStateCode;
		$('#indvLink').attr('href','/'+eePath+'/auth/'+stateAbbr+'/'+locale+'/individualApplication');
	},
	
	cancelEditArea : function( e ) {
		var target = $(e.target);
		...
		target.closest('.inactiveEditSection').find('.edit').focus();
		hideValidationErrors();
	},
	
	updatePassword : function( inputID ) {
		var $this = this,
			target = $('#'+inputID);
			
		blockUIForProfile();
		this.setUpdatePasswordModelInfo();
		var username = ffeUserName;
		if(!isEmpty(username)) {
			this.updatePasswordModel.save(null, {
				success : function(model, response) {
					console.log(response.errors[0].errorType);
					switch (response.errors[0].errorType) {
						case '200':
							$this.fetchGetSystemUserInfoToUpdateSession();
							//$this.refreshTemplate();
							setTimeout(function() {$('#passwordUpdateNotification').append($this.profileSuccesUpdatingTemplate());}, 1000);
							break;
						case 'T100':
							$this.showTimoutError('passwordUpdateNotification');
							break;
						case '500':
							$this.refreshTemplate();
							setTimeout(function() {$('#passwordUpdateNotification').append($this.profileErrorUpdatingTemplate({
								'message' : $this.resources['ffe.ee.myAccount.profile.changesNotSaved'] + "<br/>" + "<br/>" +
								$this.resources['ffe.ee.myAccount.profile.changePasswordOnce']
							}));}, 1000);
							break;
						default:
							$this.refreshTemplate();
						...
						$('#passwordValidationContainer').find('.edit').focus();}, 1000);
							break;
					}
					$.unblockUI();
	...
	setUpdatePasswordModelInfo : function () {
		var language = locale;
		
		this.updatePasswordModel.set({'userName' : ffeUserName});
		this.updatePasswordModel.set({'password' : $.trim($('#currentPassword').val())});
		this.updatePasswordModel.set({'newPassword' : $.trim($('#newPassword').val())});
		this.updatePasswordModel.set({'email' : this.model.get('email')});
		this.updatePasswordModel.set({'language' : language});
		
		modelDeletePropertyErrorsEmailID(this.updatePasswordModel);
	},
	...
	updateEmail : function() {
		...
		blockUIForProfile();
		$('#emailValidationContainer').find('.edit').focus();

		//removes SAMLtoken as it somehow gets set on this model if you try to update email2x in same session
		this.updateEmailModel=new myProfileEIDMIntegration_updateEmailBBModel(initializeEIDMIntegrationUpdateEmail());
		
		this.setUpdateEmailInfo();
		this.updateEmailModel.set({'userName' : username});
		this.updateEmailModel.save(null, {
			success : function(model, response) 
			{
				...
				{			
					$this.updateSystemUserEmail();				
					//update profile model
					$this.model.set({'language' : language});
					setTimeout(function(){$('#emailValidationContainer').find('.edit').focus();},250);
				}
				else if(response.errors[0].errorType ==='T100') {
					$this.showTimoutError('emailUpdateNotification');
				}
				else
				{
					$.unblockUI();
					setTimeout(function() {$('#emailUpdateNotification').append($this.profileErrorUpdatingTemplate({
						'message' : resources['ffe.ee.myAccount.profile.changesNotSaved']
					}));}, 1000);
					$('#emailValidationContainer').find('.edit').focus();
				}
			},
	...
	setUpdateEmailInfo : function () {
		var language = locale;
		
		this.updateEmailModel.set({'language' : language});
		this.updateEmailModel.set({'email' : $.trim($('#emailInputField').val())});	
		
		if($('#emailCheckbox').is(":checked") === true) {
			this.updateEmailModel.set({'subscriptionTrigger' : true});
		}
		else {
			this.updateEmailModel.set({'subscriptionTrigger' : false});
		}
		
		modelDeletePropertyErrorsEmailID(this.updateEmailModel);
	},
	
	updateSystemUserEmail : function() 
	{
		var $this = this,
			email = this.updateEmailModel.get('email'),
			systemUserIdentifier = this.getSystemUserInfoModel.get('systemUser').systemUserIdentifier,
			personIdentifier = this.getSystemUserInfoModel.get('systemUser').personIdentifier,
			subscription = this.updateEmailModel.get('subscriptionTrigger');
		
		this.setSystemUserEmail();
		//this.updateSystemUserEmailModel.set({'userName' : ffeUserName});
		this.updateSystemUserEmailModel.save(null, {
			success : function(model, response) {
				$.unblockUI();
				$this.fetchGetSystemUserInfoToUpdateSession();
				var subscription = $this.updateEmailModel.get('subscriptionTrigger');
				
				//update profile model
				$this.model.set({'email' : email});
				$this.model.set({'systemUserIdentifier' : systemUserIdentifier});
				$this.model.set({'personIdentifier' : personIdentifier});
				$this.model.set({'systemUserLoginName' : ffeUserName});
				
				//$this.refreshTemplate();
				if(subscription === true) {
					$('#emailUpdateNotification').append($this.profileSubscribeTemplate());
					setTimeout(function() {$('#emailUpdateNotification').append($this.profileSuccesUpdatingTemplate());}, 1000);
				}
				else {
					setTimeout(function() {$('#emailUpdateNotification').append($this.profileSuccesUpdatingTemplate());}, 1000);
				}
				...
				setTimeout(function(){$('#emailValidationContainer').find('.edit').focus();},1000);
			},
			error : function(model, response) 
			{
				try
	...
	setSystemUserEmail : function() {
		var systemUserIdentifier = this.getSystemUserInfoModel.get('systemUser').systemUserIdentifier,
			personIdentifier = this.getSystemUserInfoModel.get('systemUser').personIdentifier,
			subscriptionTrigger = this.updateEmailModel.get('subscriptionTrigger'),
			email = this.updateEmailModel.get('email');
		
		this.updateSystemUserEmailModel.set({'subscriptionTrigger' : subscriptionTrigger});
		this.updateSystemUserEmailModel.set({'emailAddress' : email});
		this.updateSystemUserEmailModel.set({'systemUserIdentifier' : systemUserIdentifier});
		this.updateSystemUserEmailModel.set({'personIdentifier' : personIdentifier});
		this.updateSystemUserEmailModel.set({'systemUserLoginName' : ffeUserName});
	},
	
	updateEmailDisplay : function(){
		var updatedEmail = this.updateEmailModel.get('email');
		$('#updatedEmailDisplay').html(updatedEmail);
	},
	
	updatePhoneNumber : function() {
		this.updatePhoneNumberModel.set({'phoneNumber' : $.trim($('#primaryPhoneEdit').val())});
		this.model.trigger('openUpdatePhoneNumberModal');
	},
	...
	updateSecurityQuestions : function() {
		...
		var language = locale;
		var username = ffeUserName,
			questions = this.updateSecurityQuestionsModel.get('securityQuestions');
		
		for(var i = 0; i < 3; i++) {
			questions.push(newEIDMSecurityQuestion());
			
			questions[i].question = $.trim($('#securityqt'+i).val());
			questions[i].answer = $.trim($('#securityanswer'+i).val());
			questions[i].index = i;
		}
		this.updateSecurityQuestionsModel.set({'userName': username});
		this.updateSecurityQuestionsModel.set({'securityQuestions': questions});
		this.updateSecurityQuestionsModel.set({'language' : language});
		
		this.model.trigger('openSecurityQuestionPasswordModal');
	},
	
	updateHomeAddress : function() {
		this.setHomeAddress();
		this.model.trigger('openUpdateAddressModal');
	},
	
	setHomeAddress : function() {
		var username = ffeUserName,
			state = $.trim($('#homeAddressStateDropDownOptions').find('select').val()),
			stateNonAbbr ="";
			
		for( var x=0; x < stateData.length; x++) {
			if(state === stateData[x].stateName) {
				stateNonAbbr = stateData[x].stateCode;
				break;
			}
		}
		
		this.updateAddressModel.set({'addressLine1' : $.trim($('#homeAddress1').val())});
		this.updateAddressModel.set({'addressLine2' : $.trim($('#homeAddress2').val())});
		this.updateAddressModel.set({'city' : $.trim($('#homeAddressCity').val())});
		this.updateAddressModel.set({'state' : stateNonAbbr});
		this.updateAddressModel.set({'zipCode' : $.trim($('#homeAddressZipCode').val())});
		this.updateAddressModel.set({'userName' : username});
		
		modelDeletePropertyErrorsEmailID(this.updateAddressModel);
	},
	
	updateState : function() {
		var $this = this,
			systemUserLoginName = ffeUserName,
			state = this.setUpdateStateModelInfo(),
			systemUserIdentifier = this.getSystemUserInfoModel.get('systemUser').systemUserIdentifier;
			
		for( var x = 0; x < stateData.length; x++) {
			if(state === stateData[x].stateName) {
				stateAbbr = stateData[x].stateCode;
				break;
			}
		}
		
		blockUIForProfile();
		if(!isEmpty(systemUserLoginName)) {
			this.updateRegisteredStateModel.set({"systemUserLoginName" : systemUserLoginName});
			this.updateRegisteredStateModel.save(null, {
				success : function(model, response) {
					$this.fetchGetSystemUserInfoToUpdateSession();
					//$this.getSystemUserInfoModel.set({'registeredStateCode' : state});
					//update profile model
					$this.model.set({'registeredStateCode' : state});
					$this.model.set({'systemUserIdentifier' : systemUserIdentifier});
					$.unblockUI();
					
					//$this.refreshTemplate();
					$this.updateStateDisplayed();
					$('#stateUpdateNotification').empty();
					setTimeout(function() {$('#stateUpdateNotification').append($this.profileSuccesUpdatingTemplate());
					
					$('#stateLiveInContainer').find('.edit').focus();},1000);
				},
				error : function(model, response) 
				{
					try
					{
						...
						if(responseText.errors[0].errorType === 'T100')
						{
							$this.showTimoutError('stateUpdateNotification');
						}
						else
						{
							$.unblockUI();
							setTimeout(function() {$('#stateUpdateNotification').append($this.profileErrorUpdatingTemplate({
								'message' : $this.resources['ffe.ee.myAccount.profile.changesNotSaved']
							}));
	...
	setUpdateStateModelInfo : function () {
	    var stateAbbr = $.trim($('#stateDropDownOptions').find('select').val()),
			systemUserIdentifier = this.getSystemUserInfoModel.get('systemUser').systemUserIdentifier;
					
		this.updateRegisteredStateModel.set({'state' : stateAbbr});
		this.updateRegisteredStateModel.set({'systemUserIdentifier' : systemUserIdentifier});
		this.updateRegisteredStateModel.set({'personIdentifier' : ffeUserName});
		
		
		return stateAbbr;
	},
	
	updateStateDisplayed : function() {
		var updatedState = this.updateRegisteredStateModel.get('state');
		var updatedStateNonAbbr ="";
		for( var x=0; x < stateData.length; x++) {
			if(updatedState === stateData[x].stateCode) {
				updatedStateNonAbbr = stateData[x].stateName;
			}
		}
		
		$('#updatedStateDisplay').html(updatedStateNonAbbr);
		$("#statelogoName").text(updatedStateNonAbbr);
	},
	
	appendUserLevel : function() {
		var userLvl = this.getSystemUserInfoModel.get('systemUser').userLevel,
			stateLiveIn = this.model.get('registeredStateCode'),
			pending = true;
		
		if(isEmpty(userLvl)) {
			this.checkIDProofStatus();
		}
		else if(userLvl === 'verified') {
			$('#isUserVerified').append(this.identityVerifiedTemplate());
			$('#idProofMessage').append(this.identitytoUpdateCallTemplate());
		}
	},
	
	checkIDProofStatus : function() {
		
		var systemUser =this.getSystemUserInfoModel.get('systemUser');
		var idVerified = isIDProofed(systemUser, ffeLOAUserLvl); 
		
		if(idVerified) {
			$('#isUserVerified').append(this.identityVerifiedTemplate());
			$('#idProofMessage').remove();
		}
		else {
			this.idProofStatusNotVerified();
		}
	},
	
	idProofStatusNotVerified : function() {
		var eidmAttemps = '',
			farsAttempts = '',
			esdAttemps = '',
			numberofAttempts = this.getSystemUserInfoModel.get('systemUser');
		...
		//checking for true if more than one there are documents under review
		esdAttemps = countIDProofingAttempts(numberofAttempts.personIDProofingEvent, '4', 'proofingEsdEngagedIndicator');
		
		if((farsAttempts === 0 && eidmAttemps === 0) ||
			(farsAttempts >= 2 && eidmAttemps < 2)) {
			$('#isUserVerified').append(this.identityNotVerifiedTemplate());
			$('#idProofMessage').remove();
		}
		else {
			if(farsAttempts === 2 && eidmAttemps === 2 && esdAttemps > 0) {
				this.checkESDStatus();
			}
			else {
				$('#isUserVerified').append(this.identityNotVerifiedTemplate());
	...
	checkESDStatus : function() {
		var eventCase,
			eventAttempts = this.getSystemUserInfoModel.get('systemUser');
		
		eventCase = checkESDIDProofingAttempts(eventAttempts.personIDProofingEvent);
		
		if(eventCase === '3' || eventCase === '1') {
			$('#isUserVerified').append(this.identitVerificationPendingTemplate());
			$('#idProofMessage').append(this.identityUnderESDReviewTemplate());
		}
		else if (eventCase === '2' || eventCase === '4' || eventCase === '0') {
			$('#isUserVerified').append(this.identitVerificationPendingTemplate());
			$('#idProofMessage').append(this.identityUnderESDReviewNeedMoreDocsTemplate());
		}
	},
	
	idProofNow : function() {
		var stateAbbr = this.getSystemUserInfoModel.get('systemUser').registeredStateCode;
		window.location.href = "/"+eePath+"/auth/"+stateAbbr+"/"+locale+"/myAccount?from=myProfile#IDProofingGetStarted";
	},
	
	idProofUploadDocs : function() {
		var stateAbbr = this.getSystemUserInfoModel.get('systemUser').registeredStateCode;
		window.location.href = "/"+eePath+"/auth/"+stateAbbr+"/"+locale+"/myAccount?from=myProfile#IDProofingResults:ESD100";
	},
	
	//TODO: have common stuff for these 2 methods
	getNotifications : function() {
		var context = this,
			notifCollection = this.notificationsCollection,
			oldURL = notifCollection.url,
			//ONLY GET GLOBAL MESSAGES
			url = environment+"/ee-rest/auth/global/"+locale+"/EeAccount/retrieveNotifications/"+ffeUserName;
		
		notifCollection.url = url;
		this.notificationsCollection.fetch({
			success : function(collection, response) 
			{	
				notifCollection.url = oldURL;
				console.log('success fetching notification collection');
				//TESTING MESSAGE
				context.addNotifications();
	...
	addNotifications : function() {
		...
		if(notifications.length > 0) {
			for(var i = 0; i < notifications.length; i++) {
				...
				{
					link = createLinkForDocument(notifications.models[i].attributes.linkUrl, locale, notifications.models[i].attributes.linkText, 
					 this.resources['ffe.ee.shared.button.download']);
				}
				else {
					link = '';
				}
			...
			$('#myProfileNotifictionArea').empty();
			$('#myProfileNotifictionArea').append(notificationList);
			$('#myProfileNotifictionArea').show();
		}
		else {
			$('#myProfileNotifictionArea').hide();
		}
	},
	
	fetchCCRUserInfoProfile : function() {
		var context = this,
		systemUserLoginName = ffeUserName,
		routes = router;
		
		this.fetchCCRSystemUserInfoModel.set({'userId': ffeCCRUserID});
		//this.fetchCCRSystemUserInfoModel.set({'userId': 'tester99'});
		this.fetchCCRSystemUserInfoModel.save(null, {
			success : function(model, response) {
				console.log("successful fetch CCR user info");
				
			},
			error : function(model, response) {
				console.log("error in fetch CCR user info");
			}
		});
	},
	
	fetchApplicationsByPersonID : function() {
	    if(!isEmpty(postCCRApplicantIDToken) && postCCRApplicantIDToken !=='$paramPostCCRApplicantID'){
			var context = this, url = '';
			url = environment+"/ee-rest/auth/"+postCCRState+"/"+locale+"/CallCenterRepresentative/fetchAllApplicationsForPersonId/"+postCCRApplicantIDToken;

			this.fetchApplicationByPersonIDModel.url = url;
			this.fetchApplicationByPersonIDModel.fetch({
				success : function(model, response) {
					//set token to fetch application by person model.
					if(isEmpty(postCCRAppIDToken) || postCCRAppIDToken ==='$postCCRAppID'){
						postCCRAppIDToken = context.fetchApplicationByPersonIDModel.userId;
					}
					context.model.trigger("fetchApplicationByApplicationID");
					console.log("successful fetch CCR by person ID");
					
				},
				error : function(model, response) {
					context.model.trigger("fetchApplicationByApplicationID");
					console.log("error in fetch CCR by person ID");
				}
			});
		}else{
			this.model.trigger("fetchApplicationByApplicationID");
			console.log("No Person ID Passed in");
		}
	},
		
	fetchApplicationByApplicationID : function() {
		if(!isEmpty(postCCRAppIDToken) && postCCRAppIDToken !=='$postCCRAppID'){
			var context = this, url = '';
	
			url = environment+"/ee-rest/auth/"+postCCRState+"/"+locale+"/CallCenterRepresentative/fetchSlimInsuranceApplicationById/"+postCCRAppIDToken;	
			
			this.fetchApplicationByApplicationIDModel.url = url;
			this.fetchApplicationByApplicationIDModel.fetch({
				success : function(model, response) {
					$.unblockUI();
					context.model.trigger("refreshProfileLandingTemplates");
					router.navigate("CCRLandingPage", {trigger: true});
					console.log("successful fetch CCR Application");
				},
				error : function(model, response) {
					console.log("error in fetch CCR Application");
				}
			});
		}else{
			$.unblockUI();
			this.model.trigger("refreshProfileLandingTemplates");
			router.navigate("CCRLandingPage", {trigger: true});
			console.log("No Applicaiton ID Passed in");
		}
	},
	
	showTimoutError : function( id ) {
		var target = $('#'+id);
		target.empty();
		target.append(this.timeoutErrorTemplate());
		target.show();
	}
});
var myProfileProfileBBView = new MyProfile_ProfileBBView();

var MyProfile_LandingPageBBView = FFEView.extend({
 
	el : $("#myProfileLandingPage"),
	...
	//templates
	profileLandingPageTemplate : _.template($('#profileLandingPageTemplate').html()),
	landingCurrentApplicationsTemplate : _.template($('#landingCurrentApplicationsTemplate').html()),
	landingInvalidApplicationsTemplate : _.template($('#landingInvalidApplicationsTemplate').html()),
	...
	initialize : function() {
		...
		// "this" context. The Underscore.js bindAll method fixes loss of 
		// context in the bound methods
		_.bindAll(this,'render', 'initialFetch', 'refreshTemplate','goToURL','toStartApplicationScreen','setStatelink','toCCRStateSelect','getAppStatusByCode','getCurrentApplicationID');
		
		this.model.bind('refreshProfileLandingTemplates', this.refreshTemplate);
	...
	events : {
		"click #toStartApplicationScreen" : "toStartApplicationScreen",
		'click #toCCRStateSelect' : 'toCCRStateSelect'
	},
	...
	initialFetch : function() {
		if(ffeCCRUser ==='true'){	
			//Check to see if CCR user exists
			//this.model.trigger("fetchCCRUserInfoProfile");		
			
			//Check to see if person exists to query CCR.
			//this.model.trigger("fetchApplicationByPersonID");

			//Check if App ID exists for CCR if so, do lookup.
			//this.model.trigger("fetchApplicationByApplicationID");
	...
	refreshTemplate : function() {
	    ...
	    $("#myProfileLandingPage").empty();
	    var strLandingPageHeading = (!isEmpty(this.resources['ffe.ee.myAccount.profile.LOALandingPage.heading']) ? this.resources['ffe.ee.myAccount.profile.LOALandingPage.heading'] : '');
	    var currentApplications ='';
	    
	  	$("#myProfileLandingPage").append(this.profileLandingPageTemplate({
			"environment" : environment,
			'heading': strLandingPageHeading
		}));
		...
		if(ffeCCRUser ==='true')
		{
			//TODO: Add logic to compare SAML against retrieved CCR User and replace info.
			if(!isEmpty(this.fetchApplicationByApplicationIDModel)){
				currentApplications = this.fetchApplicationByApplicationIDModel.get('insuranceApplication');
				
				strLandingPageHeading = strLandingPageHeading.replace('[FN]', this.fetchApplicationByApplicationIDModel.get('filerFirstName'));
			}
			...
			$("#myProfileLandingPage").append(this.profileLandingPageTemplate({
			    ...
			    if(!isEmpty(currentApplications))
				{
					memberFirstName ="";
					membersName="";
					applicationID = currentApplications.insuranceAppId;
					activeAppStatus =currentApplications.insuranceAppStatus;
					abbreviatedNewState= "";
					status = "";
					state = currentApplications.state;
					
					if(!isEmpty(applicationID))
					{
						
							$(".membersName").html(this.fetchApplicationByApplicationIDModel.get('filerFirstName'));
							$(".currentAppId").html(applicationID);
							
							
						
							for( m = 0; m < stateData.length; m++) {
								if(state === stateData[m].stateCode) {
									abbreviatedNewState = stateData[m].stateName;
								}
							}
						    theYear = getCurrentEnrollmentYear();
						
						
							if(!isEmpty(activeAppStatus)){
								status = this.getCCRAppStatusByCode(activeAppStatus);
							}
							
							$('#currentApplicationsHeading').show();
							$('#decorativeLine').show();
							$('#currentApplicationsSections').show();
							$("#currentAppliationsDiv").append(this.landingCurrentApplicationsTemplate({
								"index" : x,
								"id" : applicationID,
								"activeAppStatus" : status,
								"state" : abbreviatedNewState,
								"year" : theYear
							}));
							
							$('#stateLinkToMyAccount' + x).attr('href','/'+eePath+'/auth/'+state+'/'+locale+'/myAccount?appId=' + applicationID);
				
							$('#toCCRStateSelect').show();
							$('#toStartApplicationScreen').hide();
				}else{
			
					$('#currentApplicationsSections').show();
					$('#CCRLandingApplicationLink').hide();
					$('#CCRLandingHeading').hide();
					$('#CCRHeaderlabel').hide();
					$('#decorativeLine2').show();
					$('#toCCRStateSelect').show();
					$('#toStartApplicationScreen').hide();
				}
			}		
		...
		else
		{
			...
			currentApplications = this.getSystemUserInfoModel.get('systemUser').exchangeUserInsuranceApp;

		    strLandingPageHeading = strLandingPageHeading.replace('[FN]', this.getSystemUserInfoModel.get('systemUser').firstName);
		    $("#myProfileLandingPage").empty();
		  	$("#myProfileLandingPage").append(this.profileLandingPageTemplate({
				"environment" : environment,
				'heading': strLandingPageHeading
			...
			if(!isEmpty(currentApplications))
			{
				...
				for( x=0; x < currentApplications.length; x++)
				{
					memberFirstName ="";
					membersName="";
					 applicationID = currentApplications[x].insuranceAppId;
					 activeAppStatus =currentApplications[x].insuranceAppStatus;
					 abbreviatedNewState= "";
					 status = "";
					 state = currentApplications[x].state;
					...
					if(!isEmpty(applicationID))
					{
							...
							if(activeAppStatus === "STARTED" || activeAppStatus === "COMPLETED"){ 
								status = this.getAppStatusByCode(activeAppStatus);
								theYear = getCurrentEnrollmentYear();
								$('#currentApplicationsHeading').show();
								$('#decorativeLine').show();
								$('#currentApplicationsSections').show();
							...
							else if(activeAppStatus === "INACTIVE" || activeAppStatus === "ARCHIVED")
							{
								oldApplications.push(applicationID + " " + activeAppStatus);
							}
							
							this.setStatelink(state, x);
						}
					}
					
				}
					
				//status inactive or archived
				if(oldApplications.length !== 0){
					$("#inactiveApplicationsDiv").append(this.landingInvalidApplicationsTemplate());
					$('#applicationSelect').append('<option value="select">' + this.resources['ffe.ee.myProfile.selectApplication'] + '</option>');
					for(var t =0; t<oldApplications.length; t++){
						var value = "application" + t;
						$('#applicationSelect').append( '<option value="value">'+oldApplications[t]+'</option>');
					}
				}	
		}
			
		//show logout link, hide login
		$('#headerEmail').css('display','inline');
		$('#headerUserItem').css('display','inline');
		
	
	},
	
	//function to retrieve status RB
	getAppStatusByCode : function(code)
	{
		if(code === "STARTED"){
			return resources['ffe.ee.myAccount.application.status.started'];
		}
		else if(code === "COMPLETED"){
			return  resources['ffe.ee.myAccount.application.status.complete'];
		}
		

	},
	
	getCCRAppStatusByCode : function(code)
	{
		if(code === "001"){
			return resources['ffe.ee.myAccount.application.status.started'];
		}
			...
			return  resources['ffe.ee.myAccount.application.status.enrolled'];
		}
		

	},
	
	toStartApplicationScreen : function(){
		
		this.model.trigger('refreshStartApplicationTemplates');
		router.navigate("startApplication", {trigger: true});
	},
	
	setStatelink : function (state, index) {
		var appId = this.getCurrentApplicationID(index);
		var stateAbbr = state;
		$('#stateLinkToMyAccount' + index).attr('href','/'+eePath+'/auth/'+stateAbbr+'/'+locale+'/myAccount?appId=' + appId);
	},

	
	getCurrentApplicationID : function(index)
	{
		var currentApplications = this.getSystemUserInfoModel.get('systemUser').exchangeUserInsuranceApp;
		var applicationID = "";
		if(!isEmpty(currentApplications))
		{
			 applicationID = currentApplications[index].insuranceAppId;
		}		
	...
	toCCRStateSelect : function () {
		this.model.trigger('refreshChangeTenantModalTemplates');
	}
	
});
var myProfileLandingPageBBView = new MyProfile_LandingPageBBView();

        
// stub variable declarations for agent broker

var myProfileAgentBrokerSearchPageBBView = null,
    myProfileAgentBrokerNoClientPageBBView = null,
	 myProfileAgentBrokerQuestionsPageBBView = null,
    myProfileAgentBrokerQuestionsResultsBBView = null,
    myProfileAgentBrokerNoAssisterQuestionsBBView = null,
    myProfileFindPersonResponseBBModel = null,
    myProfileFindPersonRequestBBModel = null,
	 myProfileFetchAgentBrokerQuestionsBBModel = null,
	 myProfileVerifyAgentBrokerQuestionsBBModel = null,
    myProfileDoesUserHaveAccessToApplicationBBModel = null;


//This BBView is for agent broker flow
var MyProfile_StartApplicationBBView = FFEView.extend({
 
	el : $("#startApplicationPage"),
	...
	landingStartApplicationTemplate : _.template($('#landingStartApplicationTemplate').html()),
	...
	initialize : function() {
		...
		// "this" context. The Underscore.js bindAll method fixes loss of 
		// context in the bound methods
		_.bindAll(this,'render', 'refreshTemplate','goToIndApp','openChangeTenantModal');
		
		this.model.bind('refreshStartApplicationTemplates', this.refreshTemplate);
	...
	// handlers
	events : {
		'click #indvLink' : 'goToIndApp',
		'click #openChangeTenantModal' : 'openChangeTenantModal'
	},
	...
	refreshTemplate : function() {
		...
		var displayedStateName = " ";
		var registeredState = this.getSystemUserInfoModel.get('systemUser').registeredStateCode; 
		console.log("state from Start Page = "+registeredState);
		for( var x=0; x < stateData.length; x++) {
			//for state displayed
			if(registeredState === stateData[x].stateCode) {
				displayedStateName = stateData[x].stateName;
			}
		}


      var strResidentText = (!isEmpty(this.resources['ffe.ee.myProfile.profile.startApplication.notAResident']) ? this.resources['ffe.ee.myProfile.profile.startApplication.notAResident'] : '');
      strResidentText = strResidentText.replace(/\[state\]/g, displayedStateName);
      $("#startApplicationPage").empty();
        $("#startApplicationPage").append(this.landingStartApplicationTemplate({
			'displayedStateName' : displayedStateName,
			'residentText': strResidentText
		}));
		
		//is.setStatelink();
	},
	//TODO: refactor , myProfile_ProfileBBView has similar code
	//also myAccount_eligibilityBBView
	goToIndApp : function () {
		$('#appInSameTenantMessageRegion').hide();
		$('#appUnsupportedTenantMessageRegion').hide();
		var systemUser= this.getSystemUserInfoModel.get('systemUser');
		
		var registeredAbbr = systemUser.registeredStateCode;
		var idVerified = false;
		var hasAppInTenant = false;
				
		idVerified= isIDProofed(systemUser,ffeLOAUserLvl);
		
		//after check if IDVerified, check the states
		hasAppInTenant = checkApplicationsForUser(systemUser.exchangeUserInsuranceApp, registeredAbbr);
		var esdAttemps = countIDProofingAttempts(systemUser.personIDProofingEvent, '4', 'proofingEsdEngagedIndicator');
		
		if(this.isUnsupportedTenant(registeredAbbr)){	
			//show error
			$('#appUnsupportedTenantMessageRegion').show();
		}
		else if(!hasAppInTenant) {
		    ...
		    if(idVerified) {
		    	...
		    	if(esdAttemps > 0) {
					navigateToIndAppHelper(registeredAbbr, locale, '');
				}
				else {
			...
			//show error
			$('#appInSameTenantMessageRegion').show();
		}
	},

	isUnsupportedTenant: function(strTenant){
	   var bUnsupported = true;
		var ffmStates = $('#stateLiveInDropDown');

		if(!isEmpty(strTenant) && ffmStates.length >0){
		   for(var i = 0; i < ffmStates[0].length; i++){
			   if(strTenant === ffmStates[0][i].value){
					 bUnsupported = false;
					 break;
				}
			}
	...
	openChangeTenantModal : function () {
		this.model.trigger('refreshChangeTenantModalTemplates');
	}
});
var myProfileStartApplicationBBView = new MyProfile_StartApplicationBBView();	
    //This BBView is for agent broker flow
var MyProfile_ChangeTenantModalBBView = FFEView.extend({
 
	el : $("#changeTenantModalPage"),
	...
	landingChangeTenantModalTemplate : _.template($('#landingChangeTenantModalTemplate').html()),
	landingStartApplicationTemplate : _.template($('#landingStartApplicationTemplate').html()),
	stateNonAbbreviatedDropDownOptionsTemplateFFM : _.template($('#stateNonAbbreviatedDropDownOptionsTemplateFFM').html()),
	...
	initialize : function() {
		...
		// "this" context. The Underscore.js bindAll method fixes loss of 
		// context in the bound methods
		_.bindAll(this,'render', 'refreshTemplate','close','setUpdateStateModelInfo','updateState','setCCRStateLink','fetchGetSystemUserInfoToUpdateSession');
		
		this.model.bind('refreshChangeTenantModalTemplates', this.refreshTemplate);
	...
	// handlers
	events : {
		'click #tenantStateModalClose' : 'close',
		'click #tenantStateModalSave' : 'updateState',
		'click #setCCRStateLink' : 'setCCRStateLink'	
	},
	...
	refreshTemplate : function() {
		$("#changeTenantModalPage").empty();
		$("#changeTenantModalPage").append(this.landingChangeTenantModalTemplate());
		this.$el.dialog({
			autoOpen: false,
			resizable: false,
			width: 780,
			...
			title: this.resources['ffe.ee.myAccount.profile.changeTenantModal.title']
		});
		
		this.$el.dialog('open');
		//this.initializeValidation();
		this.$el.parent().children().find('.ui-dialog-title').focus();
		//this.close();
	
		$('#tenantStateOptions').empty();
		$('#tenantStateOptions').append(this.stateNonAbbreviatedDropDownOptionsTemplateFFM({
			"idToUse" : "tenantStateDropDown"
		...
		this.$el.parent().children().find('.ui-dialog-title').attr('tabindex', '-1').focus();
	},
	...
	initializeValidation : function() 
	{
		...
		if(ffeCCRUser ==='true')
		{
			eventTrigger = ("#setCCRStateLink");
			formContainer = $("#changeTenantStateValidationContainer");
		}else
		{
			eventTrigger = ("#tenantStateModalSave");
			formContainer = $("#changeTenantStateValidationContainer");
		}
		
		if(formContainer.length > 0) 
		{
			var updateStateValidator = new FFM.FormValidator(formContainer, eventTrigger);
			updateStateValidator.setRule("notBlank", ["^(?!\\s*$).+", this.resources['ffe.ee.shared.validations.notBlank']]);
		}
	},
	
	fetchGetSystemUserInfoToUpdateSession : function() {
		var $this = this;
		var systemUserLoginName = ffeUserName;
			
			
		this.getSystemUserInfoModel.set({'systemUserLoginName' : systemUserLoginName});
		this.getSystemUserInfoModel.fetch({
			success : function(model, response) { 
				var state = response.systemUser.registeredStateCode;
				console.log("state from tenant Page = "+state);
				//$this.setGetSystemUserInfoToProfileModel();
				$.unblockUI();
				$this.model.trigger('refreshStartApplicationTemplates');
	...
	setUpdateStateModelInfo : function () {
		var newState = $('#tenantStateOptions').find('select').val();

		var	systemUserIdentifier = this.getSystemUserInfoModel.get('systemUser').systemUserIdentifier;
		
		this.updateRegisteredStateModel.set({'state' : newState});
		this.updateRegisteredStateModel.set({'systemUserIdentifier' : systemUserIdentifier});
		this.updateRegisteredStateModel.set({'personIdentifier' : ffeUserName});
		
		
	},
	setCCRStateLink : function () {
		var newState = $('#tenantStateOptions').find('select').val();
		
		window.location.href = '/'+eePath+'/auth/'+newState+'/'+locale+'/individualApplication';
	}
	
	
});
var myProfileChangeTenantModalBBView = new MyProfile_ChangeTenantModalBBView();	
    //
// Attention: This file is generated once and can be modified by hand
// Generated by: pageBBview.js.vsl in andromda-backbone-js-ui cartridge.
// myProfile
...
// web
//
var MyProfile_ProfileModalBBView = FFEView.extend({
	// The el property is the root element of the view.
	// You can only bind to events fired in this element or its children.
	el : $("#myProfileModal"),
	...
	userSecurityQuestionsModel : myProfileEIDMIntegrationUserFetchSecurityQuestionsEIDMBBModel,
	updateAddressModel : myProfileEIDMIntegrationUpdateHomeAddressEIDMBBModel,
	updateSystemUserAddressModel : myProfileSystemUserUpdateSystemUserAddressBBModel,
	updateSystemUserPhoneNumberModel : myProfileSystemUserUpdateSystemUserPhoneNumberBBModel,
	getSystemUserInfoModel : myProfileGetSystemUserInfoBBModel,
	fetchUserInfoModel : myProfileFetchUserInfoBBModel,
	// Underscore.js template variables points to the template in the XHTML
	// file. There can be more than one template. 
	profileSecurityQuestionsContainerTemplate : _.template($('#profileSecurityQuestionsContainerTemplate').html()),
	profileSecurityQuestionTemplate : _.template($('#profileSecurityQuestionTemplate').html()),
	profileSuccesUpdatingTemplate : _.template($('#profileSuccesUpdatingTemplate').html()),
	profileErrorUpdatingTemplate : _.template($('#profileErrorUpdatingTemplate').html()),
	profileSubscribeTemplate : _.template($('#profileSubscribeTemplate').html()),
	profileModalCouldNotProcessRequestTemplate : _.template($('#profileModalCouldNotProcessRequestTemplate').html()),
	timeoutErrorTemplate : _.template($('#timeoutErrorTemplate').html()),
	// Namespace is used for looking up keys in the resource bundle
	namespace : "ffe.ee",
	...
	initialize : function() {
		...
		// "this" context. The Underscore.js bindAll method fixes loss of 
		// context in the bound methods
		_.bindAll(this, 'initUpdatePhoneNumberModal','initializePhoneNumberValidation','savePhoneNumberUpdate', 'setPhoneNumberInfo',
					'initUpdateAddressModal', 'saveAddressUpdate', 'initializeAddressValidation', 'closeDialog', 'close',
					'updatePhoneNumberDisplayed','updateAddressDisplayed', 'saveSystemUserPhoneNumber', 'setSystemUserPhoneNumber',
					'updateSystemUserAddress', 'setSystemUserAddress','fetchGetSystemUserInfoToUpdateSession', 'fetchUserSecurityQuestions',
					'openUpdatePhoneNumberModal', 'openUpdateAddressModal', 'showTimoutError');
		
		this.model.bind('openUpdatePhoneNumberModal', this.openUpdatePhoneNumberModal);
		this.model.bind('openUpdateAddressModal', this.openUpdateAddressModal);
	...
	// handlers
	events : {
		'click #confirmSecurityQuestionsPhoneNumberUpdate' : 'savePhoneNumberUpdate',
		'click #confirmSecurityQuestionsAddressUpdate' : 'saveAddressUpdate',
		'click .returnToProfile' : 'closeDialog'
	},
	
	openUpdatePhoneNumberModal : function() {
	     var $this = this;
		  var postCompleteFunction = function() {
				$this.initUpdatePhoneNumberModal();
		  };
		  this.fetchUserSecurityQuestions(postCompleteFunction);
	},

	openUpdateAddressModal : function() {
		  var $this = this;
		  var postCompleteFunction = function() {
				$this.initUpdateAddressModal();
		  };
		  this.fetchUserSecurityQuestions(postCompleteFunction);
	},

	fetchUserSecurityQuestions : function(postCompleteFunction) {
		var $this = this,
			userName = ffeUserName;

		var questions = this.userSecurityQuestionsModel.get('securityQuestions');
		if(isEmpty(questions) || questions.length == 0){
		    // we don;t have the securty questions yet, go get them
			 blockUIForProfile();
			 this.userSecurityQuestionsModel.set({'securityQuestions': []});
			 this.userSecurityQuestionsModel.set({'userName': userName});
			 this.userSecurityQuestionsModel.fetch({
				 success : function(model, response) {
					$this.userSecurityQuestionsModel.set({
						'securityQuestions' : secQuestionEncoding( $this.userSecurityQuestionsModel.get('securityQuestions'), locale )
					});
					 $.unblockUI();
					 $this.model.trigger('renderDisplaySecurityQuestions');
					 ...
					 try
						{
							...
							if(responseText.errors[0].errorType === 'T100')
							{
								$this.showTimoutError('securityQuestionsUpdateNotification');
							}
							else
							{
								$('#securityQuestionsUpdateNotification').append($this.profileErrorUpdatingTemplate({
									 'message' : $this.resources['ffe.ee.myAccount.profile.marketplaceCouldNotProcessRequest']
								 }));
							}
						}
						catch(e)
		    ...
		    // we have already retrieved the security questions, just use the ones we have
			 postCompleteFunction();
		}
	},

	initUpdatePhoneNumberModal : function() {
		...
		this.$el.empty();
		this.$el.append(this.profileSecurityQuestionsContainerTemplate({
			'containerID' : 'updatePhoneSecurityQuestionsSection',
			'eventIDTrigger' : 'confirmSecurityQuestionsPhoneNumberUpdate',
			'descriptionText' : this.resources['ffe.ee.myAccount.profile.securityModal.phoneDescriptionText']
		}));
		this.$el.dialog({
			autoOpen: false,
			resizable: false,
			...
			modal: true,
			descriptionId: this.resources['ffe.ee.myAccount.dynamicallyLoadedPage'],
			title: this.resources['ffe.ee.myAccount.profile.securityModal.title.updatePhoneNumber']
		});
				
		questions = this.userSecurityQuestionsModel.get('securityQuestions');
		$('#updatePhoneSecurityQuestionsSection').children().eq(0).empty();
		$('#updatePhoneSecurityQuestionsSection').children().eq(1).empty();
		
		if(!isEmpty(questions) && questions.length > 0) {
			for(var x = 0; x < 3; x++) {
				if(x === 0 || x === 1) {
					$('#updatePhoneSecurityQuestionsSection').children().eq(0).append(this.profileSecurityQuestionTemplate({
						"inputId" : 'phoneUpdateSecurityanswer',
						"question" : questions[x].question,
						"index" : x+1
					}));
				} 
				else {
					$('#updatePhoneSecurityQuestionsSection').children().eq(1).append(this.profileSecurityQuestionTemplate({
						"inputId" : 'phoneUpdateSecurityanswer',
						"question" : questions[x].question,
						"index" : x +1
					}));
			...
			this.$el.dialog('open');
			heights = $('.divHeight', '#myProfileModal').map(function() {
				return $(this).height();
			}).get();
			maxHeight = Math.max.apply(null, heights);
			$('.divHeight', '#myProfileModal').height(maxHeight+10);
		}
		else {
			this.$el.dialog('open');
			this.$el.empty();
			this.$el.append(this.profileModalCouldNotProcessRequestTemplate());
		}
		this.initializePhoneNumberValidation();
		this.close();
		$('h2[tabindex=-1]').removeAttr('tabindex');
		this.$el.parent().children().find('.ui-dialog-title').attr('tabindex', '-1').focus();
	},
	
	initUpdateAddressModal : function() {
		var heights,
			maxHeight,
			questions;
		...
		this.$el.empty();
		this.$el.append(this.profileSecurityQuestionsContainerTemplate({
			'containerID' : 'updateAddressSecurityQuestionsSection',
			'eventIDTrigger' : 'confirmSecurityQuestionsAddressUpdate',
			'descriptionText' : this.resources['ffe.ee.myAccount.profile.securityModal.addressDescriptionText']
		}));
		this.$el.dialog({
			autoOpen: false,
			resizable: false,
			...
			modal: true,
			descriptionId: this.resources['ffe.ee.myAccount.dynamicallyLoadedPage'],
			title: this.resources['ffe.ee.myAccount.profile.securityModal.title.updateAddress']
		});
		
		questions = this.userSecurityQuestionsModel.get('securityQuestions');
		
		$('#updateAddressSecurityQuestionsSection').children().eq(0).empty();
		$('#updateAddressSecurityQuestionsSection').children().eq(1).empty();
		
		if(!isEmpty(questions) && questions.length > 0) {
			for(var x = 0; x < 3; x++) {
				if(x === 0 || x === 1) {
					$('#updateAddressSecurityQuestionsSection').children().eq(0).append(this.profileSecurityQuestionTemplate({
						"inputId" : 'addressUpdateSecurityanswer',
						"question" : questions[x].question,
						"index" : x+1
					}));
				}
				else {
					$('#updateAddressSecurityQuestionsSection').children().eq(1).append(this.profileSecurityQuestionTemplate({
						"inputId" : 'addressUpdateSecurityanswer',
						"question" : questions[x].question,
						"index" : x +1
					}));
	...
	initializePhoneNumberValidation : function() {
		var eventTrigger = ("#confirmSecurityQuestionsPhoneNumberUpdate"),
			formContainer = $("#updatePhoneSecurityQuestionsSection");
		
		if(formContainer.length > 0) {
			var updateValidator = new FFM.FormValidator(formContainer, eventTrigger);
			updateValidator.setRule("notBlank", ["^(?!\\s*$).+", this.resources['ffe.ee.shared.validations.notBlank']]);
		}
	},
	
	initializeAddressValidation : function() {
		var eventTrigger = ("#confirmSecurityQuestionsAddressUpdate"),
			formContainer = $("#updateAddressSecurityQuestionsSection");
				 ...
				 try
					{
						...
						{
							console.log("Non-timeout error fetching user info");
						}
					}
					catch(e)
					{ 
	...
	savePhoneNumberUpdate : function() {
		var	$this = this,
			username = ffeUserName;
			
		blockUIForProfile();
		this.setPhoneNumberInfo();
		this.updatePhoneNumberModel.set({'userName' : username});
		this.updatePhoneNumberModel.save(null, {
			success : function(model, response) {
				console.log(response.errors[0].errorType);
				switch(response.errors[0].errorType) {
					case '200':
						$this.model.trigger('refreshProfileTemplates');
						$this.saveSystemUserPhoneNumber();
						break;
					case '204':
						$this.model.trigger('refreshProfileTemplates');
						$.unblockUI();
						setTimeout(function() {$('#phoneNumberUpdateNotification').append($this.profileErrorUpdatingTemplate({
							'message' : $this.resources['ffe.ee.myAccount.profile.changesNotSaved']
						}));
						$('#primaryPhoneValidationContainer').find('.edit').focus();}, 1000);
						break;
					case 'T100':
						$this.showTimoutError('phoneNumberUpdateNotification');
						break;
					default:
						$.unblockUI();
						$this.model.trigger('refreshProfileTemplates');
		...
		$('#primaryPhoneValidationContainer').find('.edit').focus();
		this.$el.dialog('close');
		this.$el.empty();
	},
	
	setPhoneNumberInfo : function() {
		this.updatePhoneNumberModel.set({'securityQuestions' : []});
		var language = locale;
		var username = ffeUserName,
			questions = this.userSecurityQuestionsModel.get('securityQuestions'),
			questionsToSend = [];
		...
		for(var i = 0; i < 3; i++) {
			questionsToSend.push(newEIDMSecurityQuestion());
			
			questionsToSend[i].question = questions[i].question;
			questionsToSend[i].answer = $.trim($('#phoneUpdateSecurityanswer'+(i+1)).val());
			questionsToSend[i].index = i;
		}
		this.updatePhoneNumberModel.set({'userName': username});
		this.updatePhoneNumberModel.set({'securityQuestions': questionsToSend});
		this.updatePhoneNumberModel.set({'language' : language});
		
		if($('#primaryPhoneCheckbox').is(":checked") === true ){
			this.updatePhoneNumberModel.set({'subscriptionTrigger' : true});
		}
		else{
			this.updatePhoneNumberModel.set({'subscriptionTrigger' : false});
		}
		
		modelDeletePropertyErrorsEmailID(this.updatePhoneNumberModel);
	},
	
	saveSystemUserPhoneNumber : function() {
		var	$this = this;			
		var phoneNumber = this.updatePhoneNumberModel.get('phoneNumber');
		this.setSystemUserPhoneNumber();
		this.updateSystemUserPhoneNumberModel.save(null, {
			success : function(model, response) {
				$this.fetchGetSystemUserInfoToUpdateSession();
				//update profile model 
                $this.model.set({'phoneNumber' : phoneNumber});
				
				var subscription = $this.updatePhoneNumberModel.get('subscriptionTrigger');
				$this.model.trigger('refreshProfileTemplates');
				$.unblockUI();
				if(subscription === true) {
					$('#phoneNumberUpdateNotification').append($this.profileSubscribeTemplate());
					setTimeout(function() {$('#phoneNumberUpdateNotification').append($this.profileSuccesUpdatingTemplate());}, 1000);
				}
				else {
					setTimeout(function() {$('#phoneNumberUpdateNotification').append($this.profileSuccesUpdatingTemplate());}, 1000);
				}
				setTimeout(function() {
					$.unblockUI();
					$this.updatePhoneNumberDisplayed();
					$('#primaryPhoneValidationContainer').find('.edit').focus();
				}, 1000);
			},
			error : function(model, response) {
				...
				$('#primaryPhoneValidationContainer').find('.edit').focus();}, 1000);
				console.log('system User Phone Number');
			}
		});
	},
	
	setSystemUserPhoneNumber : function() {
		var systemUserIdentifier = this.getSystemUserInfoModel.get('systemUser').systemUserIdentifier,
			personIdentifier = this.getSystemUserInfoModel.get('systemUser').personIdentifier,
			subscriptionTrigger = this.updatePhoneNumberModel.get('subscriptionTrigger'),
			phoneNumber = this.updatePhoneNumberModel.get('phoneNumber');
			
		this.updateSystemUserPhoneNumberModel.set({'subscriptionTrigger' : subscriptionTrigger});
		this.updateSystemUserPhoneNumberModel.set({'phoneNumber' : phoneNumber});
		this.updateSystemUserPhoneNumberModel.set({'personIdentifier' : personIdentifier});
		this.updateSystemUserPhoneNumberModel.set({'systemUserIdentifier' : systemUserIdentifier});
		this.updateSystemUserPhoneNumberModel.set({'systemUserLoginName' : ffeUserName});
		
	},
	
	updatePhoneNumberDisplayed : function() {
		var updatedPhoneNumber = this.updatePhoneNumberModel.get('phoneNumber');
		$('#updatedPhoneNumberDisplay').html(updatedPhoneNumber);
	},
	
	saveAddressUpdate : function() {
		var $this = this,
			username = ffeUserName;
		
		blockUIForProfile();
		this.setHomeAddressSecurityQuestions();
		this.updateAddressModel.set({'userName' : ffeUserName});
		this.updateAddressModel.save(null, {
			success : function(model, response) {
				console.log(response.errors[0].errorType);
				switch(response.errors[0].errorType) {
					case '200':
						$this.updateSystemUserAddress();
						break;
					case 'T100':
						$this.showTimoutError('addressUpdateNotification');
						break;					
					case '204':
						$this.model.trigger('refreshProfileTemplates');
						$('#addressUpdateNotification').append($this.profileErrorUpdatingTemplate({
							'message':  $this.resources['ffe.ee.myAccount.profile.changesNotSaved']
						}));
						setTimeout(function() {
							$.unblockUI();
							$('#addressValidationContainer').find('.edit').focus();}, 250);
						break;
					default: //500
						$this.model.trigger('refreshProfileTemplates');
						$('#addressUpdateNotification').append($this.profileErrorUpdatingTemplate({
	...
	setHomeAddressSecurityQuestions : function() {
		this.updateAddressModel.set({'securityQuestions' : []});
		var username = ffeUserName,
			questions = this.updateAddressModel.get('securityQuestions'),
			userQuestions = this.userSecurityQuestionsModel.get('securityQuestions');
		
		for(var i = 0; i < 3; i++) {
			questions.push(newEIDMSecurityQuestion());
			
			questions[i].question = userQuestions[i].question;
			questions[i].answer = $.trim($('#addressUpdateSecurityanswer'+(i+1)).val());
			questions[i].index = i;
		}
	...
	updateSystemUserAddress : function() {
		var $this = this,
			username = ffeUserName,
			state = this.model.get('registeredStateCode');
		
		this.setSystemUserAddress();
		this.updateSystemUserAddressModel.save(null, {
			success : function(model, response) {
				$this.fetchGetSystemUserInfoToUpdateSession();
				//update profile model 
				$this.model.set({'addressLine1' : $.trim($('#homeAddress1').val())});
				$this.model.set({'addressLine2' : $.trim($('#homeAddress2').val())});
				$this.model.set({'city' : $.trim($('#homeAddressCity').val())});
				$this.model.set({'state' : state});
				$this.model.set({'zipCode' : $.trim($('#homeAddressZipCode').val())});
				$this.model.set({'userName' : username});
				$this.model.trigger('refreshProfileTemplates');
				$.unblockUI();
				setTimeout(function() {
					$this.updateAddressDisplayed();
					$('#addressUpdateNotification').append($this.profileSuccesUpdatingTemplate());
					$('#addressValidationContainer').find('.edit').focus();
				}, 500);
			},
			error : function(model, response) {
				$this.model.trigger('refreshProfileTemplates');
	...
	setSystemUserAddress : function() {
		var username = ffeUserName,
			systemUserIdentifier = this.getSystemUserInfoModel.get('systemUser').systemUserIdentifier,
			personIdentifier = this.getSystemUserInfoModel.get('systemUser').personIdentifier;
		
		this.updateSystemUserAddressModel.set({'addressLine1' : $.trim(this.updateAddressModel.get('addressLine1'))});
		this.updateSystemUserAddressModel.set({'addressLine2' : $.trim(this.updateAddressModel.get('addressLine2'))});
		this.updateSystemUserAddressModel.set({'city' : $.trim(this.updateAddressModel.get('city'))});
		this.updateSystemUserAddressModel.set({'state' : $.trim(this.updateAddressModel.get('state'))});
		this.updateSystemUserAddressModel.set({'zipCode' : $.trim(this.updateAddressModel.get('zipCode'))});
		this.updateSystemUserAddressModel.set({'systemUserIdentifier' : $.trim(systemUserIdentifier)});
		this.updateSystemUserAddressModel.set({'personIdentifier' : $.trim(personIdentifier)});
		this.updateSystemUserAddressModel.set({'systemUserLoginName' : $.trim(username)});
	},
	
	updateAddressDisplayed : function(){
		var address = this.updateAddressModel.get('addressLine1')+ "<br />";
		if(!isEmpty(this.updateAddressModel.get('addressLine2'))) {
			address += this.updateAddressModel.get('addressLine2')+"<br />";
		}
		address+= this.updateAddressModel.get('city')+ ", "+this.updateAddressModel.get('state')+ " " + this.updateAddressModel.get('zipCode');
		$('#updatedAddressDisplay').html(address);
	},
	...
	close : function() {
		var $this = this,
			input = this.$el.find('input').eq(0);
		
		$('.icon-circle_remove').on('click', function() {
			if(input.attr('id') === 'addressUpdateSecurityanswer1') {
				$('#addressValidationContainer').find('.edit').focus();
			}
			else if(input.attr('id') === 'phoneUpdateSecurityanswer1') {
				$('#primaryPhoneValidationContainer').find('.edit').focus();
			}
		});
	},
...
var myProfileProfileModalBBView = new MyProfile_ProfileModalBBView();
//
// Attention: This file is generated once and can be modified by hand
// Generated by: pageBBview.js.vsl in andromda-backbone-js-ui cartridge.
// myProfile
...
// web
//
var MyProfile_SecurityQuestionsPasswordModalBBView = FFEView.extend({
	// The el property is the root element of the view.
	// You can only bind to events fired in this element or its children.
	el : $("#securityQuestionsPasswordConfirm"),
	...
	initialize : function() {
		...
		// "this" context. The Underscore.js bindAll method fixes loss of 
		// context in the bound methods
		_.bindAll(this, 'refreshTemplate', 'saveSecurityQuestionsUpdate', 'setPasswordSecurityQuestions',
					'initializeValidation','updateSecurityQuestionsDisplayed', 'close','fetchGetSystemUserInfoToUpdateSession',
					'showTimoutError');
		
		this.model.bind('openSecurityQuestionPasswordModal', this.refreshTemplate);
	...
	// handlers
	events : {
		'click #confirmSecurityQuestionsPassword' : 'saveSecurityQuestionsUpdate'
	},
	...
	refreshTemplate : function() {
		...
		// Underscore.js template		
		this.$el.empty();
		this.$el.append(this.updateSecurityQuestionsPasswordModalTemplate());
		this.$el.dialog({
			autoOpen: false,
			resizable: false,
			width: 780,
			...
			modal: true,
			descriptionId: this.resources['ffe.ee.myAccount.dynamicallyLoadedPage'],
			title: this.resources['ffe.ee.myAccount.profile.securityModal.title.updateSecurityQuestions']
		});
	...
	initializeValidation : function() {
		var eventTrigger = $("#confirmSecurityQuestionsPassword"),
			formContainer = $("#securityQuestionsPasswordContainer");
		
		if(formContainer.length > 0) {
			var registrationValidator = new FFM.FormValidator(formContainer, eventTrigger);
			registrationValidator.setRule("notBlank", ["^(?!\\s*$).+", this.resources['ffe.ee.shared.validations.notBlank']]);
		}
	},
	...
	saveSecurityQuestionsUpdate : function() {
		var securityQs,
			$this = this,
			username = ffeUserName;
			
		blockUIForProfile();
		this.setPasswordSecurityQuestions();
		$('#securityQuestionsUpdateNotification').empty();
		$('#securityQuestionsUpdateNotification').show();
		this.updateSecurityQuestionsModel.set({'userName': username});
		this.updateSecurityQuestionsModel.save(null, {
			success : function(model, response) {
				...
				switch(response.errors[0].errorType) {
					case '200':
						$this.fetchGetSystemUserInfoToUpdateSession();
						securityQs = $this.updateSecurityQuestionsModel.get('securityQuestions');
						$this.userSecurityQuestionsModel.set({'securityQuestions' : securityQs});
						$.unblockUI();
						$this.model.trigger('renderDisplaySecurityQuestions');
						setTimeout(function() {$('#securityQuestionsUpdateNotification').append($this.profileSuccesUpdatingTemplate());}, 1000);
						$this.updateSecurityQuestionsDisplayed();
						break;
					case '204':
						$.unblockUI();
						setTimeout(function() {$('#securityQuestionsUpdateNotification').append($this.profileErrorUpdatingTemplate({
							'message' : resources['ffe.ee.myAccount.profile.changesNotSaved']
						}));}, 1000);
						break;
					case 'T100':
				...
				setTimeout(function() {
					$('#saveSecurityQuestionsContainer').find('.edit').focus();}, 1000);
			},
			error : function(model, response) 
			{
				try
		...
		$('#saveSecurityQuestionsContainer').find('.edit').focus();
		this.$el.dialog('close');
		this.$el.empty();
	},
	
	setPasswordSecurityQuestions : function() {
		this.updateSecurityQuestionsModel.set({'password': $.trim($('#securityQsPassword').val())});
		
		modelDeletePropertyErrorsEmailID(this.updateSecurityQuestionsModel);
	},
	
	updateSecurityQuestionsDisplayed : function(){
		
		var questions = this.updateSecurityQuestionsModel.get('securityQuestions');
		
		$('#updatedSecurityQuestionsDisplay').empty();
		
		if (!isEmpty(questions)) {
			for(var x = 0; x < questions.length; x++) {
				$('#updatedSecurityQuestionsDisplay').append(this.profileDisplaySecurityQuestionTemplate({
					"question" : questions[x].question,
					"index" : x
				}));
			}
	...
	close : function() {
		...
		$('.icon-circle_remove').on('click', function() {
			if(input.attr('id') === 'securityQsPassword') {
				$('#saveSecurityQuestionsContainer').find('.edit').focus();
			}
		});
	},
...
var myProfileSecurityQuestionsPasswordModalBBView = new MyProfile_SecurityQuestionsPasswordModalBBView();
//
// Attention: This file is generated once and can be modified by hand
// Generated by: pageBBview.js.vsl in andromda-backbone-js-ui cartridge.
// registration
...
// web
//
var MyProfile_LoginTermsAndConditionsBBView = FFEView.extend({
	// The el property is the root element of the view.
	// You can only bind to events fired in this element or its children.
	...
	// The "model" attribute is the one that the model binding library uses
	model : myProfileProfileBBModel,
	termsConditionsModel : myProfileEEAccountSaveTermsAndConditionsBBModel,
	getSystemUserInfoModel : myProfileGetSystemUserInfoBBModel,
	...
	// Underscore.js template variables points to the template in the XHTML
	// file. There can be more than one template.
	profileTermsAndConditionsTemplate : _.template($('#profileTermsAndConditionsTemplate').html()),
	...
	initialize : function() {
		...
		// "this" context. The Underscore.js bindAll method fixes loss of 
		// context in the bound methods
		_.bindAll(this, 'render', 'refreshTemplate', 'goToLandingPage', 'termsAndConditions', 'setTermsAndConditions');
		
		this.model.bind('refreshLogInTermsAndConditionsTemplates', this.refreshTemplate);
		this.model.bind('termsAndConditions', this.termsAndConditions);
		
		// Custom validation handlers could be added here

		// Initialize generally completes by calling this.render
		//var $this = this;
		//setTimeout(function() {$this.termsAndConditions()}, 500);
	},

	// The events object links all UI events in this view with their event
	// handlers
	events : {
		"click #termsAndConditionsAccept" : "termsAndConditions",
		"click #termsAndConditionsDecline" : "cancel"
	},
	...
	{		
		this.$el.empty();
		this.$el.append(this.profileTermsAndConditionsTemplate());
		$('.innerContainer').children().eq(0).hide();
		$('.nav').eq(0).hide();
	},
	...
	goToLandingPage : function() {
		...
		//			$this.model.trigger("refreshProfileLOALandingTemplates");
		//			router.navigate("issuerLandingPage", {trigger: true});	
		//		} 
		//		else{
					$this.model.trigger("refreshProfileLandingTemplates");
					router.navigate("landingPage", {trigger: true});
		//		}
		//	},
		//	error : function(model, response) {
		//		console.log(response);
	...
	cancel : function() {
		window.location.href = "/"+eePath+"/global/"+locale+"/registration";
	},
	
	termsAndConditions : function() {
		var $this = this,
			routes = router,
			oldUrl = this.termsConditionsModel.url,
			systemUserIdentifier = this.getSystemUserInfoModel.get('systemUser').systemUserIdentifier;
				
		blockUIForProfile();
		this.termsConditionsModel.set({'systemUserId' : systemUserIdentifier});
		this.termsConditionsModel.save(null, {
			success : function(model, response) 
			{
				if(isEmpty(ffeCCRUser) || ffeCCRUser==='false' || ffeCCRUser===false)
				{
					showUserMenuOptions();
				}
				else
				{
					showCCRUserMenuOptions();
				}
				console.log(response);
			},
			error : function(model, response) {
	...
	setTermsAndConditions : function() 
	{
		...
		this.termsConditionsModel.set({'termsAccepted' : true});
		this.termsConditionsModel.set({'systemUserId' : systemUserIdentifier});
	}
});
var myProfileLoginTermsAndConditionsBBView = new MyProfile_LoginTermsAndConditionsBBView();
//
// Attention: This file is generated once and can be modified by hand
...
var MasterBBView = Backbone.View.extend({
	...
	profileModel : myProfileProfileBBModel,
	
	profileUpdateRegisteredStateModel : myProfileUpdateRegisteredStateBBModel,
	
	profileGetSystemUserInfo : myProfileGetSystemUserInfoBBModel,

	profileView : myProfileProfileBBView,
	
	profileLandingView : myProfileLandingPageBBView,
	
	findPersonResponseModel : myProfileFindPersonResponseBBModel,
	
	findPersonRequestModel:myProfileFindPersonRequestBBModel,
	
	startApplicationPageView : myProfileStartApplicationBBView,
	
	changeTenantModalView : myProfileChangeTenantModalBBView,
	
	agentBrokerSearchPageView : myProfileAgentBrokerSearchPageBBView,
	
	agentBrokerNoClientPageView : myProfileAgentBrokerNoClientPageBBView,
	
	agentBrokerQuestionsPageView :myProfileAgentBrokerQuestionsPageBBView,
	
	agentBrokerQuestionsResultsView : myProfileAgentBrokerQuestionsResultsBBView,

   agentBrokerNoAssisterQuestionsView : myProfileAgentBrokerNoAssisterQuestionsBBView,

	profileModalView : myProfileProfileModalBBView,
	
	profileSecurityQuestionsPasswordModalView : myProfileSecurityQuestionsPasswordModalBBView,
		
	profileUpdatePasswordModel : myProfileEIDMIntegrationUpdatePasswordBBModel,
	
	profileUpdateEmailModel : myProfileEIDMIntegrationUpdateEmailBBModel,
	
	profileUpdatePhoneNumber : myProfileEIDMIntegrationUpdatePhoneNumberBBModel,
	
	profileFetchValidationsModel : myProfileEIDMIntegrationfetchEIDMValidationsBBModel,
	
	profileFetchAllSecurityQuestions : myProfileEIDMIntegrationFetchSecurityQuestionsEIDMBBModel,
	
	profileFetchUserSecurityQuestions : myProfileEIDMIntegrationUserFetchSecurityQuestionsEIDMBBModel,
	
	profileFetchUserInfo : myProfileFetchUserInfoBBModel,
	
	getSecureRedirectInfoModel : getSecureRedirectInfoBBModel,
	
	fetchAgentBrokerQuestionsModel : myProfileFetchAgentBrokerQuestionsBBModel,

	verifyAgentBrokerQuestionsModel: myProfileVerifyAgentBrokerQuestionsBBModel,

   doesUserHaveAccessToApplicationModel: myProfileDoesUserHaveAccessToApplicationBBModel,
...
var myProfileRouter = Backbone.Router.extend({
	routes:
	{
		...
		"CCRLandingPage" : "CCRLandingPage",
		
		"agentSearch" : "agentSearch",
		
		"agentNoClient" : "agentNoClient",
		
		"agentQuestions" : "agentQuestions",
		
		"agentQuestionsResults" : "agentQuestionsResults",

		"agentNoAssisterQuestions": "agentNoAssisterQuestions",
	...
	{
		this.hideAll();
		$('#profileNavContainer').hide();
		$('#CCRlandingPageNavContainer').hide();
		$('#landingPageNavContainer').show();
		$('#agentBrokerStateBar').hide();
		$('#profilePageSubNav').hide();
		$('#CCRPageSubNav').hide();
		$('#landingPageSubNav').show();
		
		//$('#fixedElementSubNav > div > div').removeClass('subNavLinkActive');
		//$('#one').addClass('subNavLinkActive');
		$("#myProfileLandingPage").show();
		$('#startApplicationNav').hide();
		$('#startApplicationClass').removeClass('guidingSection');
		$('#myProfileContentSection').addClass('cardContainer');
		$('#settingsIcon').addClass("inactive");
		//this.resetSubNavigationSection('homeSubNav');
		$('.innerContainer').children().eq(0).show();
		$('.nav').eq(0).show();
		setTitleFromResource(resources['ffe.ee.myAccount.appsCoverage.pagetitle']);
	...
	{
		this.hideAll();
		myProfileProfileModalBBView.fetchUserSecurityQuestions( function() {} );
		$('#landingPageNavContainer').hide();
		$('#CCRlandingPageNavContainer').hide();
		$('#profileNavContainer').show();
		$('#agentBrokerStateBar').hide();
		$('#landingPageSubNav').hide();
		$('#CCRPageSubNav').hide();
		$('#profilePageSubNav').show();
		
		$('#myProfilePage').show();
		$('#startApplicationNav').hide();
		$('#startApplicationClass').removeClass('guidingSection');
		$('#myProfileContentSection').addClass('cardContainer');
		$('#myAppCoverageIcon').addClass("inactive");
		
		$('.innerContainer').children().eq(0).show();
		$('.nav').eq(0).show();
		setTitleFromResource(resources['ffe.ee.myAccount.profile.pageTitle']);

	},
	
	CCRLandingPage : function()
	{
		this.hideAll();
		$('#profileNavContainer').hide();
		$('#landingPageNavContainer').hide();
		$('#CCRlandingPageNavContainer').show();
		$('#agentBrokerStateBar').hide();
		$('#profilePageSubNav').hide();
		$('#landingPageSubNav').hide();
		$('#CCRPageSubNav').show();
		...
		$('.innerContainer').children().eq(0).show();
		$('.nav').eq(0).show();
		setTitleFromResource(resources['ffe.ee.myAccount.ccrLanding.pageTitle']);
   },
	...
	agentSearch : function()
	{
		...
		$('#CCRPageSubNav').hide();
		$('#agentBrokerStateBar').show();
		$('#agentBrokerSearchPage').show();
		$('#startApplicationNav').hide();
		$('#startApplicationClass').removeClass('guidingSection');
		$('#myProfileContentSection').removeClass('cardContainer');
		$('.innerContainer').children().eq(0).show();
		$('.nav').eq(0).show();
		setTitleFromResource(resources['ffe.ee.myAccount.agentBroker.search.pageTitle']);
   },
	
	agentNoClient : function()
	{
		this.hideAll();
		$('#landingPageNavContainer').hide();
		$('#profileNavContainer').hide();
		...
		$('#CCRPageSubNav').hide();
		$('#agentBrokerStateBar').show();
		$('#agentBrokerNoClientPage').show();
		$('#startApplicationNav').hide();
		$('#startApplicationClass').removeClass('guidingSection');
		$('#myProfileContentSection').removeClass('cardContainer');
		$('.innerContainer').children().eq(0).show();
		$('.nav').eq(0).show();
		setTitleFromResource(resources['ffe.ee.myAccount.agentBroker.noClient.pageTitle']);
   },
	
	agentQuestions : function()
	{
		this.hideAll();
		$('#landingPageNavContainer').hide();
		$('#profileNavContainer').hide();
		...
		$('#CCRPageSubNav').hide();
		$('#agentBrokerStateBar').show();
		$('#agentBrokerQuestionsPage').show();
		$('#startApplicationNav').hide();
		$('#startApplicationClass').removeClass('guidingSection');
		$('#myProfileContentSection').removeClass('cardContainer');
		$('.innerContainer').children().eq(0).show();
		$('.nav').eq(0).show();
		setTitleFromResource(resources['ffe.ee.myAccount.agentBroker.questions.pageTitle']);
   },
	
	agentQuestionsResults : function()
	{
		this.hideAll();
		$('#landingPageNavContainer').hide();
		$('#profileNavContainer').hide();
		...
		$('#CCRPageSubNav').hide();
		$('#agentBrokerStateBar').show();
		$('#agentBrokerQuestionsResultsPage').show();
		$('#startApplicationNav').hide();
		$('#startApplicationClass').removeClass('guidingSection');
		$('#myProfileContentSection').removeClass('cardContainer');
		$('.innerContainer').children().eq(0).show();
		$('.nav').eq(0).show();
		setTitleFromResource(resources['ffe.ee.myAccount.agentBroker.questionResults.pageTitle']);
   },

    agentNoAssisterQuestions: function () {
        this.hideAll();
        $('#landingPageNavContainer').hide();
        $('#profileNavContainer').hide();
        $('#CCRlandingPageNavContainer').hide();
        ...
        $('#CCRPageSubNav').hide();
        $('#agentBrokerStateBar').show();
        $('#agentBrokerNoAssisterQuestionsPage').show();
        $('#startApplicationNav').hide();
        $('#startApplicationClass').removeClass('guidingSection');
        $('#myProfileContentSection').removeClass('cardContainer');
        $('.innerContainer').children().eq(0).show();
        $('.nav').eq(0).show();
        setTitleFromResource(resources['ffe.ee.myAccount.agentBroker.noQuestions.pageTitle']);
    },
    ...
    startApplication: function ()
	 {
		...
		$('#agentBrokerStateBar').hide();
		$('#CCRPageSubNav').hide();
		$('#startApplicationPage').show();
		$('#startApplicationNav').show();
		$('#startApplicationClass').addClass('guidingSection');
		$('.innerContainer').children().eq(0).hide(); // hides the light blue nav bar
		$('.nav').eq(0).show();
		setTitleFromResource(resources['ffe.ee.myAccount.startApplication.pagetitle']);
   },
	
	hideAll : function()
	{
		$('#myProfilePage').hide();
		$('#myProfileLandingPage').hide();
		$('#profileNavContainer').hide();
		$('#logInTermsAndConditionsPage').hide();
		$('#agentBrokerSearchPage').hide();
		$('#agentBrokerNoClientPage').hide();
		$('#agentBrokerQuestionsPage').hide();
		$('#agentBrokerQuestionsResultsPage').hide();
		$('#agentBrokerNoAssisterQuestionsPage').hide();
		$('#myProfileLOALandingPage').hide();
		$('#startApplicationNav').hide();
		$('#startApplicationPage').hide();
...
var router = new myProfileRouter();
Backbone.history.start({root : "/"+eePath+"/auth/"+tenantId+"/"+locale+"/myProfile/"});
