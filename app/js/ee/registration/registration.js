...
$(function($) {
  ...
  var isDirectEnrollmentConsumerBBModel = new IsDirectEnrollmentConsumerBBModel();
  var sendSecureRedirectBBModel = CommonValidationBBModel.extend({
  ...
  var sendSecureRedirectBBModel = new sendSecureRedirectBBModel();
  var getSecureRedirectInfoBBModel = CommonValidationBBModel.extend({
  ...
  var getSecureRedirectInfoBBModel = new getSecureRedirectInfoBBModel();
  var CreatePersonMappingBBModel = CommonValidationBBModel.extend({
  ...
  var Registration_LoginBBView = FFEView.extend({
    ...
    addValdidationObjectsToFFM: function() {
      ...
      FFM.defaultValidatorRules.sameEmail = [
        function(value, $group, args) {
      ...
      FFM.defaultValidatorRules.sameEEPassword = [
        function(value, $group, args) {
          var firstPassword = $("[id=" + args[0] + "]").val();
          var secondPassword = $("[id=" + args[1] + "]").val();
          if (firstPassword !== secondPassword) {
    ...
    fetchBasicValidationRules: function() {
      ...
      if (false) { // spare eidm right now
        ...
        var validations = [{
          ...
          "csrf": null,
          "regularExpression": "^[a-zA-Z0-9][a-zA-Z0-9'. -]{0,30}$",
          "fieldName": "Out of wallet Answers",
          "nullString": ""
        }, {
          "csrf": null,
          "regularExpression": "[0-9][0-9][0-9][0-9]",
          "fieldName": "Last Four SSN",
          "nullString": ""
        }, {
          "csrf": null,
          "regularExpression": "^(?!(000|666))([0-6]\\d{2}|7([0-6]\\d|7[012]))-(?!00)\\d{2}-(?!0000)\\d{4}$",
          "fieldName": "SSN",
          "nullString": ""
        }, {
          "csrf": null,
          ...
          "csrf": null,
          "regularExpression": "/^(?:(0[1-9]|1[012])[\\/.](0[1-9]|[12][0-9]|3[01])[\\/.](19|20)[0-9]{2})$/",
          "fieldName": "Date of Birth",
          "nullString": ""
        }, {
          "csrf": null,
          "regularExpression": "([a-zA-Z \\\\-'\\\\s]{1,25}){1}",
          ...
          "csrf": null,
          "regularExpression": "^[a-zA-Z0-9][a-zA-Z0-9_.@/'-]{5,74}$",
          "fieldName": "User Login",
          "nullString": ""
        }, {
          "csrf": null,
          "regularExpression": "([a-zA-Z \\\\-'\\\\s]{1,38}){1}",
          "fieldName": "City",
          "nullString": ""
        }, {
          "csrf": null,
          ...
          "csrf": null,
          "regularExpression": "[A-Za-z{5,74}]",
          "fieldName": "State",
          "nullString": ""
        }, {
          "csrf": null,
          "regularExpression": "[\\\\d]{4}",
          "fieldName": "Zip Code Extension",
          "nullString": ""
        }, {
          "csrf": null,
          "regularExpression": "(^[a-zA-Z0-9._\\\\-,'\\\\s]{1,68}){1}",
          ...
          "csrf": null,
          "regularExpression": "([a-zA-Z \\\\-'\\\\s]{1,20}){1}",
    ...
    signIn: function() {
      ...
      if (passwordStatus === 'expired') {
        router.navigate("expiredPassword", {
          trigger: true
        });
        this.model.trigger("refreshExpiredPasswordTemplates");
      } else {
        router.navigate("termsAndConditions", {
          trigger: true
        });
    ...
    forgotUsernameLink: function() {
      router.navigate("forgotUsername", {
        trigger: true
      });
  ...
  var Registration_RegistrationBBView = FFEView.extend({
    ...
    createProfile: function() {
      ...
      router.navigate("registrationSignUpResults", {
        trigger: true
      });
    },
    ...
    setModelInfo: function() {
      ...
      this.createLiteAccountModel.set({
        'firstName': $.trim($('#registrationSignUpFirstName').val())
      });
      this.createLiteAccountModel.set({
        'middleName': $.trim($('#registrationSignUpMiddleName').val())
      });
      this.createLiteAccountModel.set({
        'lastName': $.trim($('#registrationSignUpLastName').val())
      });
      this.createLiteAccountModel.set({
        'suffix': $.trim($('#registrationSignUpSuffix').val())
      });
      this.createLiteAccountModel.set({
        'email': $.trim($('#registrationSignUpEmail').val())
      });
      this.createLiteAccountModel.set({
        'password': $.trim($('#registrationSignUpPassword').val())
      });
      this.createLiteAccountModel.set({
        'securityQuestions': questions
      });
      this.createLiteAccountModel.set({
        'userName': $.trim($('#registrationSignUpUsername').val())
      });
    ...
    verifyEmailAddress: function() {
      ...
      this.verifyEmailAddressModel.set({
        'username': this.createLiteAccountModel.get('userName')
      });
  ...
  var Registration_ForgotPasswordDetailsBBView = FFEView.extend({
    ...
    continueToQuestions: function() {
      ...
      blockUIForProfile();
      this.fetchSecurityQuestionsModel.set({
        'securityQuestions': []
      });
      ...
      router.navigate("forgotPasswordQuestions", {
        trigger: true
      });
    }
  });
  ...
  var Registration_ForgotUsernameDetailsBBView = FFEView.extend({
    ...
    setUpdateUserNameModelInfo: function() {
      ...
      this.forgotUserNameModel.set({
        'firstName': $.trim($('#forgotUserNameFirstName').val())
      });
      this.forgotUserNameModel.set({
        'lastName': $.trim($('#forgotUserNameLastName').val())
      });
      this.forgotUserNameModel.set({
        'email': $.trim($('#forgotUserNameEmail').val())
      });
  ...
  var Registration_RegistrationResultsBBView = FFEView.extend({
    ...
    almostFinished: function() {
      ...
      router.navigate("registrationSignUpResults:200", {
        trigger: true
      });
    ...
    waitingToCreate: function() {
      router.navigate("registrationSignUpResults:waiting", {
        trigger: true
      });
      this.$el.empty();
    ...
    profileCouldNotBeCreated: function() {
      ...
      router.navigate("registrationSignUpResults:204", {
        trigger: true
      });
      var email = this.createLiteAccountModel.get('email');
      this.$el.empty();
    ...
    couldNotCreateAccountGeneric: function() {
      //if profile could not created
      router.navigate("registrationSignUpResults:500", {
        trigger: true
      });
      var email = this.createLiteAccountModel.get('email');
      this.$el.empty();
    ...
    userIDAlreadyExists: function() {
      router.navigate("registrationSignUpResults:E110", {
        trigger: true
      });
      this.$el.empty();
    ...
    combinationNotUnique: function() {
      router.navigate("registrationSignUpResults:E537", {
        trigger: true
      });
      this.$el.empty();
    ...
    securityQuestionsInvalidFormat: function() {
      router.navigate("registrationSignUpResults:E138", {
        trigger: true
      });
      this.$el.empty();
    ...
    securityQuestionsDuplicate: function() {
      router.navigate("registrationSignUpResults:E114", {
        trigger: true
      });
      this.$el.empty();
    ...
    mlError250: function() {
      router.navigate("registrationSignUpResults:250", {
        trigger: true
      });
      this.$el.empty();
    ...
    mlError950: function() {
      router.navigate("registrationSignUpResults:950", {
        trigger: true
      });
      this.$el.empty();
      this.$el.append(this.mlErrorTemplate());
    ...
    govDeliveryError: function() {
      router.navigate("registrationSignUpResults:990", {
        trigger: true
      });
      this.$el.empty();
  ...
  var Registration_ForgotUsernameResultsBBView = FFEView.extend({
    ...
    forgotUsernameEmail: function() {
      ...
      this.$el.append(this.forgotPasswordUsernameEmailTemplate({
        ...
        'emailScreenText2': '<a class="toResubmitLink" href="#">' + this.resources['ffe.ee.registration.forgotUsernameResults.usernameEmailText1'] + this.resources['ffe.ee.registration.clickHereLink'] + " " + this.resources['ffe.ee.registration.resubmitText'] + '</a>',
        'hiddenText': this.resources['ffe.ee.registration.forgotUsernameResults.usernameEmailHiddenText']
      }));
      router.navigate("forgotUsernameResults:usernameEmail", {
        trigger: true
      });
      $('h2[tabindex=-1]').removeAttr('tabindex');
      this.$el.find('h2').attr('tabindex', '-1').focus();
    ...
    forgotUsernameResultConfirmation: function() {
      ...
      router.navigate("forgotUsernameResults", {
        trigger: true
      });
      $('h2[tabindex=-1]').removeAttr('tabindex');
      this.$el.find('h2').attr('tabindex', '-1').focus();
  ...
  var Registration_ForgotPasswordResultsBBView = FFEView.extend({
    ...
    forgotPasswordEmail: function() {
      ...
      router.navigate("forgotPasswordResults:passwordEmail", {
        trigger: true
      });
      this.$el.empty();
      this.$el.append(this.forgotPasswordUsernameEmailTemplate({
    ...
    resultUnsuccessful: function() {
      ...
      router.navigate("forgotPasswordResults", {
        trigger: true
      });
      $('h2[tabindex=-1]').removeAttr('tabindex');
      this.$el.find('h2').attr('tabindex', '-1').focus();
    ...
    resultSuccessful: function() {
      ...
      router.navigate("forgotPasswordResults:200", {
        trigger: true
      });
      $('h2[tabindex=-1]').removeAttr('tabindex');
      this.$el.find('h2').attr('tabindex', '-1').focus();
    ...
    passwordCouldNotProcessRequest: function() {
      ...
      router.navigate("forgotPasswordResults:204", {
        trigger: true
      });
      $('h2[tabindex=-1]').removeAttr('tabindex');
      this.$el.find('h2').attr('tabindex', '-1').focus();
    ...
    passwordCouldNotProcessUsername: function() {
      ...
      router.navigate("forgotPasswordResults:username", {
        trigger: true
      });
      $('h2[tabindex=-1]').removeAttr('tabindex');
      this.$el.find('h2').attr('tabindex', '-1').focus();
    ...
    questionsAndAnswersDoNotMatch: function() {
      ...
      router.navigate("forgotPasswordResults:E513", {
        trigger: true
      });
      $('h2[tabindex=-1]').removeAttr('tabindex');
      this.$el.find('h2').attr('tabindex', '-1').focus();
    ...
    questionsDontMatch: function() {
      ...
      router.navigate("forgotPasswordResults:E521", {
        trigger: true
      });
      $('h2[tabindex=-1]').removeAttr('tabindex');
      this.$el.find('h2').attr('tabindex', '-1').focus();
    ...
    passwordInvalid: function() {
      ...
      router.navigate("forgotPasswordResults:E128", {
        trigger: true
      });
      $('h2[tabindex=-1]').removeAttr('tabindex');
      this.$el.find('h2').attr('tabindex', '-1').focus();
    ...
    passwordsDoNotMatch: function() {
      ...
      router.navigate("forgotPasswordResults:E111", {
        trigger: true
      });
      $('h2[tabindex=-1]').removeAttr('tabindex');
      this.$el.find('h2').attr('tabindex', '-1').focus();
    ...
    userIDisInvalid: function() {
      ...
      router.navigate("forgotPasswordResults:E514", {
        trigger: true
      });
      $('h2[tabindex=-1]').removeAttr('tabindex');
      this.$el.find('h2').attr('tabindex', '-1').focus();
  ...
  var Registration_ResetPasswordBBView = FFEView.extend({
    ...
    updateForgotPassword: function() {
      ...
      if (!isEmpty(username)) {
        ...
        $this.updateForgotPasswordModel.set({
          "userName": username
        });
        $this.updateForgotPasswordModel.set({
          "emailConfirmationId": uuid
        });
    ...
    setUpdateModelInfo: function() {
      ...
      this.updateForgotPasswordModel.set({
        'password': $.trim($('#resetPasswordNewPassword').val())
      });
      this.updateForgotPasswordModel.set({
        "securityQuestions": questions
      });
  ...
  var Registration_ExpiredPasswordBBView = FFEView.extend({
    ...
    updatePassword: function() {
      ...
      if (!isEmpty(username)) {
        ...
        $this.updateExpiredPasswordModel.set({
          "userName": username
        });
    ...
    setUpdateModelInfo: function() {
      this.updateExpiredPasswordModel.set({
        'oldPassword': $.trim($('#expiredPasswordOldPassword').val())
      });
      this.updateExpiredPasswordModel.set({
        'newPassword': $.trim($('#expiredPasswordNewPassword').val())
      });
    }
  });
  ...
  var Registration_RegistrationStepTwoBBView = FFEView.extend({
    ...
    goToStepThree: function() {
      ...
      router.navigate("signUpStepThree", {
        trigger: true
      });
      $('h2[tabindex=-1]').removeAttr('tabindex');
    ...
    setModelInfo: function() {
      this.createLiteAccountModel.set({
        'password': $.trim($('#registrationThreeStepPassword').val())
      });
      this.createLiteAccountModel.set({
        'userName': $.trim($('#registrationThreeStepUsername').val())
      });
    },
  ...
  Backbone.history.start({
    root: "/" + eePath + "/" + tenantId + "/" + locale + "/registration"
  });
